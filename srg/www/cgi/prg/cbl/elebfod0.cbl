      ...
      *                       Ultima revisione:    NdK del 07/03/25    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Preparazione JSON per dati                  *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *                    ___ OBSOLETO - SOSTITUITO DA 'eleabbD0'     *
      *                                                                *
      *================================================================*
      ...
      *            * Tabella codici                                    *
      *            *---------------------------------------------------*
               10  w-det-fil-jsn-ele  occurs  500.
                   15  w-det-fil-jsn-lab  pic  x(11)                  .
                   15  w-det-fil-jsn-val  pic  x(80)                  .
      *            *---------------------------------------------------*
      *            * Contatori di comodo                               *
      *            *---------------------------------------------------*
               10  w-det-fil-jsn-max      pic  9(03) value 500        .
               10  w-det-fil-jsn-ctr      pic  9(03)                  .
               10  w-det-fil-jsn-rig      pic  9(03)                  .
               10  w-det-fil-jsn-inx      pic  9(03)                  .
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-fil-jsn-ctr      .
       exe-cph-jsn-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-cph-jsn-600.
      *              *-------------------------------------------------*
      *              * Subroutine di emissione valori JSON preparati   *
      *              *-------------------------------------------------*
      ...
      *    *                                                           *
      *    * ___ SCANSIONE DI 'bfr' E SUB SCANSIONE DI 'bfk' ___       *
      *    *-----------------------------------------------------------*
       exe-cph-jsn-bfr-000.
      *              *-------------------------------------------------*
      ...
      *                  * Valori spunta                               *
      *                  *---------------------------------------------*
           perform   exe-cph-bfs-000      thru exe-cph-bfs-999        .
      *                  *---------------------------------------------*
      *                  * Lettura prodotto                            *
      *                  *---------------------------------------------*
      ...
      *    * Subroutine per emissione risultati in formato JSON        *
      *    *                                                           *
      *    * Sub-subroutine di bufferizzazione singolo elemento        *
      *    *-----------------------------------------------------------*
       exe-cph-jsn-buf-000.
      *              *-------------------------------------------------*
      *              * Test preliminare                                *
      *              *-------------------------------------------------*
           if        w-exe-jsn-lab        =    spaces or
                     ...
                     go to exe-cph-jsn-buf-900.
       exe-cph-jsn-buf-100.
      *              *-------------------------------------------------*
      *              * Incremento contatore                            *
      *              *-------------------------------------------------*
           add       1                    to   w-det-fil-jsn-ctr      .
      *              *-------------------------------------------------*
      *              * Test sul contatore                              *
      *              *-------------------------------------------------*
           if        w-det-fil-jsn-ctr    >    w-det-fil-jsn-max
                     move  w-det-fil-jsn-max
                                          to   w-det-fil-jsn-ctr      .
       exe-cph-jsn-buf-200.
      *              *-------------------------------------------------*
      *              * Label                                           *
      *              *-------------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           string    p-edt
                     ...
                     w-exe-jsn-lab
                                delimited by   spaces
                                          into w-exe-jsn-alf          .
           move      w-exe-jsn-alf        to   w-det-fil-jsn-lab
                                              (w-det-fil-jsn-ctr)     .
      *                  *---------------------------------------------*
      *                  * A value                                     *
      *                  *---------------------------------------------*
           go to     exe-cph-jsn-buf-400.
       exe-cph-jsn-buf-240.
      *                  *---------------------------------------------*
      *                  * Label senza contatore                       *
      *                  *---------------------------------------------*
           move      w-exe-jsn-lab        to   w-det-fil-jsn-lab
                                              (w-det-fil-jsn-ctr)     .
      *                  *---------------------------------------------*
      *                  * A value                                     *
      *                  *---------------------------------------------*
      ...
      *              * Value                                           *
      *              *-------------------------------------------------*
           move      w-exe-jsn-val        to   w-det-fil-jsn-val
                                              (w-det-fil-jsn-ctr)     .
       exe-cph-jsn-buf-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     exe-cph-jsn-buf-999.
       exe-cph-jsn-buf-999.
           exit.
      ...
      *    * Subroutine per emissione risultati in formato JSON        *
      *    *                                                           *
      *    * Sub-subroutine di emissione file JSON                     *
      *    *-----------------------------------------------------------*
       exe-cph-jsn-emi-000.
      *              *-------------------------------------------------*
      *              * Test preliminare                                *
      *              *-------------------------------------------------*
           if        w-det-fil-jsn-ctr    =    zero
                     go to exe-cph-jsn-emi-900.
       exe-cph-jsn-emi-100.
      *              *-------------------------------------------------*
      *              * Normalizzazione contatore                       *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-fil-jsn-inx      .
      *              *-------------------------------------------------*
      *              * Normalizzazione ','                             *
      *              *-------------------------------------------------*
      ...
      *              * Ciclo di scansione                              *
      *              *-------------------------------------------------*
           add       1                    to   w-det-fil-jsn-inx      .
           if        w-det-fil-jsn-inx    >    w-det-fil-jsn-ctr
                     go to exe-cph-jsn-emi-900.
           if        w-det-fil-jsn-inx    >    w-det-fil-jsn-max
                     go to exe-cph-jsn-emi-900.
       exe-cph-jsn-emi-300.
      *              *-------------------------------------------------*
      *              * Test se prima riga                              *
      *              *-------------------------------------------------*
           if        w-det-fil-jsn-inx    >    1
      ...
      *              * Test preliminare                                *
      *              *-------------------------------------------------*
           if        w-det-fil-jsn-lab
                    (w-det-fil-jsn-inx)   =    spaces or
                     w-det-fil-jsn-val
                    (w-det-fil-jsn-inx)   =    spaces
                     go to exe-cph-jsn-emi-200.
      *              *-------------------------------------------------*
      *              * Eventuale ultimo elemento                       *
      *              *-------------------------------------------------*
           if        w-det-fil-jsn-inx    =    w-det-fil-jsn-ctr
      ...
      *              *-------------------------------------------------*
        ...
        exe-cph-bfs-400.
      *              *-------------------------------------------------*
      *              * Eventuale normalizzazione flag di spunta        *
      *              *-------------------------------------------------*
           if        w-exe-flg-spn        =    spaces
                     move  "N"            to   w-exe-flg-spn          .
        exe-cph-bfs-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to      exe-cph-bfs-999.
        exe-cph-bfs-999.
           exit.
