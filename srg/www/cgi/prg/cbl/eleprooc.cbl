      ...
      *                                                                *
      *                    Espansione prodotti in ordine a clienti     *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *================================================================*
      ...
      *            * Contatori elementi                                *
      *            *---------------------------------------------------*
               10  w-det-tbl-roc-ctr      pic  9(04)                  .
               10  w-det-tbl-roc-ctx      pic  9(04)                  .
      *            *---------------------------------------------------*
      *            * Tabella codici                                    *
      *            *---------------------------------------------------*
               10  w-det-tbl-roc-ele  occurs  999.
                   15  w-det-tbl-roc-prt  pic  9(11)                  .
                   15  w-det-tbl-roc-prg  pic  9(05)                  .
                   15  w-det-tbl-roc-qta  pic s9(10)v9(03)            .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   det-tbl-roc-000      thru det-tbl-roc-999        .
       exe-rds-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-tbl-roc-ctx      .
       emi-rig-orc-200.
           add       1                    to   w-det-tbl-roc-ctx      .
           if        w-det-tbl-roc-ctx    >    w-det-tbl-roc-ctr
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-tbl-roc-prt
                    (w-det-tbl-roc-ctx)   to   rf-ocr-num-prt         .
           move      w-det-tbl-roc-prg
                    (w-det-tbl-roc-ctx)   to   rf-ocr-num-prg         .
           move      "pgm/orc/fls/ioc/obj/iofocr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           ...
           move      "S"                  to   p-sgn                  .
           move      "<G"                 to   p-edm                  .
           move      w-det-tbl-roc-qta
                    (w-det-tbl-roc-ctx)   to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Emissione                               *
      ...
      *                  *---------------------------------------------*
           move      rf-ocr-cod-arc       to   w-let-arc-dcc-cod      .
           move      rf-ocr-dpz-arc       to   w-let-arc-dcc-dpz      .
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-det-tbl-roc-ctr      .
       det-tbl-roc-100.
      *              *-------------------------------------------------*
      *              * Start su file [ocr]                             *
      *              *-------------------------------------------------*
           ...
           move      w-exe-cnv-pro        to   rf-ocr-num-pro         .
      ...
      *                  *---------------------------------------------*
______*    if        rf-ocr-tip-ord       =    "P" or
______*              rf-ocr-tip-ord       =    "C"
______*              go to det-tbl-roc-200.
      *                  *---------------------------------------------*
      *                  * Test su data documento                      *
      *                  *---------------------------------------------*
           if        rf-ocr-dat-doc       >    w-det-qta-orc-dat
                     go to det-tbl-roc-200.
      *                  *---------------------------------------------*
      ...
      *                  * Incremento tabella                          *
      *                  *---------------------------------------------*
           add       1                    to   w-det-tbl-roc-ctr      .
      *
           move      rf-ocr-num-prt       to   w-det-tbl-roc-prt
                                              (w-det-tbl-roc-ctr)     .
           move      rf-ocr-num-prg       to   w-det-tbl-roc-prg
                                              (w-det-tbl-roc-ctr)     .
           move      d-qev-roc-qta-dev    to   w-det-tbl-roc-qta
                                              (w-det-tbl-roc-ctr)     .
       det-tbl-roc-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
