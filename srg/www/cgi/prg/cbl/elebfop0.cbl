      ...
      *                                                                *
      *                    Verifica esistenza prodotto in documento    *
      *                                                                *
      *                    ELETTRA                                     *
      *                                                                *
      *================================================================*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-exe-cnv-prt        to   rf-bfr-num-prt         .
      ...
      *                  * Test su protocollo                          *
      *                  *---------------------------------------------*
           if        rf-bfr-num-prt       not  = w-exe-cnv-prt
                     go to exe-cph-dst-900.
       exe-cph-dst-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
