      ...
      *              *-------------------------------------------------*
           ...
           else if   w-exe-tip-ope        =    "UP"
                     perform exe-cph-upr-000
                                          thru exe-cph-upr-999
           else if   w-exe-tip-ope        =    "DG"
                     perform exe-cph-udg-000
                                          thru exe-cph-udg-999
      ...
      *              *-------------------------------------------------*
           if        w-exe-flg-spn        =    "S"
                     ...
                     move  w-exe-rsm-cnv  to   rf-ost-cod-rsm
      ...
      *              *-------------------------------------------------*
           ...
           move      "NL"                 to   f-cfr                  .
           move      w-slc-num-num-dst    to   rf-osd-num-dst         .
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-wrg-300.
      *              *-------------------------------------------------*
      *              * Test max su archivio [osd]                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su numero distinta                     *
      *                  *---------------------------------------------*
           if        rf-osd-num-dst       not  =  w-slc-num-num-dst
                     go to exe-cph-wrg-900.
       exe-cph-wrg-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *                  *---------------------------------------------*
       ...
       exe-cph-wru-100.
      *              *-------------------------------------------------*
      *              * Ottenimento record [hdr]                        *
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "DSTPRO    "         to   f-key                  .
           move      w-slc-num-num-dst    to   rf-hdr-num-dst         .
           move      w-exe-pro-cnv        to   rf-hdr-num-pro         .
           move      w-exe-cod-ubi        to   rf-hdr-cod-ubi         .
           move      "ele/ods/fls/ioc/obj/iofhdr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              * Aggiornamento                                   *
      *              *-------------------------------------------------*
           add       w-exe-qtu-cnv        to   rf-hdr-qta-ubi         .
       exe-cph-wru-300.
      *              *-------------------------------------------------*
      *              * Aggiornamento record [hdr]                      *
      *              *-------------------------------------------------*
           perform   upd-rec-hdr-000      thru upd-rec-hdr-999        .
       exe-cph-wru-400.
      *              *-------------------------------------------------*
      *              * Esito dell'aggiornamento                        *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-cph-wru-600.
      *              *-------------------------------------------------*
      *              * Se record [hdr] non trovato                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Scrittura record [hdr] normalizzato         *
      *                  *---------------------------------------------*
           perform   nor-rec-hdr-000      thru nor-rec-hdr-999        .
      *                  *---------------------------------------------*
      *                  * Ritorno a scrittura                         *
      *                  *---------------------------------------------*
           go to     exe-cph-wru-100.
      ...
      *    * Ciclo di lettura e preparazione html                      *
      *    *                                                           *
      *    * Subroutine di aggiornamento ubicazione principale         *
      *    *-----------------------------------------------------------*
       exe-cph-upr-000.
      *              *-------------------------------------------------*
      *              * Test preliminari                                *
      ...
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     exe-cph-upr-900.
       exe-cph-upr-030.
      *                  *---------------------------------------------*
      *                  * Test su codice ubicazione                   *
      *                  *---------------------------------------------*
           if        w-exe-cod-ubi        not  = spaces
                     go to exe-cph-upr-100.
      *                  *---------------------------------------------*
      *                  * Messaggio in uscita                         *
      *                  *---------------------------------------------*
           display   "<div id='msg' class='sel'>"                     .
      ...
      *                  *---------------------------------------------*
           move      w-exe-cod-ubi        to   rf-mau-prm-ubi (1)      .
      *                  *---------------------------------------------*
      *                  * Note ubicazione                             *
      *                  *---------------------------------------------*
           perform   exe-cph-upr-not-000  thru exe-cph-upr-not-999    .
           move      w-all-str-alf        to   rf-mau-not-ubi         .
       exe-cph-upr-300.
      *              *-------------------------------------------------*
      *              * Aggiornamento record [mau]                      *
      *              *-------------------------------------------------*
           perform   upd-rec-mau-000      thru upd-rec-mau-999        .
       exe-cph-upr-400.
      *              *-------------------------------------------------*
      *              * Esito dell'aggiornamento                        *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       exe-cph-upr-600.
      *              *-------------------------------------------------*
      *              * Se record [mau] non trovato                     *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Scrittura record [mau] normalizzato         *
      *                  *---------------------------------------------*
           perform   nor-rec-mau-000      thru nor-rec-mau-999        .
      *                  *---------------------------------------------*
      *                  * Ritorno a scrittura                         *
      *                  *---------------------------------------------*
           go to     exe-cph-upr-100.
      ...
      *    * Ciclo di lettura e preparazione html                      *
      *    *                                                           *
      *    * Subroutine di cancellazione saldo ubicazione a zero       *
      *    *-----------------------------------------------------------*
       exe-cph-udg-000.
      *              *-------------------------------------------------*
      *              * Test preliminari                                *
      ...
      *                  * Ad uscita                                   *
      *                  *---------------------------------------------*
           go to     exe-cph-udg-900.
       exe-cph-udg-030.
      *                  *---------------------------------------------*
      *                  * Test su codice ubicazione                   *
      *                  *---------------------------------------------*
           if        w-exe-cod-ubi        not  = spaces
                     go to exe-cph-udg-100.
      *                  *---------------------------------------------*
      *                  * Messaggio in uscita                         *
      *                  *---------------------------------------------*
           display   "<div id='msg' class='sel'>"                     .
      ...
      *              * Update record [mms]                             *
      *              *-------------------------------------------------*
           perform   upd-rec-mms-000      thru upd-rec-mms-999        .
       exe-cph-udg-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     exe-cph-udg-999.
       exe-cph-udg-999.
           exit.

      *    *===========================================================*
      *    * Riscrittura record [mms]                                  *
      *    *-----------------------------------------------------------*
       upd-rec-mms-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-exe-pro-cnv        to   rf-mms-num-mag         .
           move      spaces               to   rf-mms-var-mag         .
           move      w-exe-cod-ubi        to   rf-mms-cod-dsl         .
           move      "pgm/mag/fls/ioc/obj/iofmms"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to upd-rec-mms-900.
       upd-rec-mms-400.
      *              *-------------------------------------------------*
      *              * Aggiornamento flag zero                         *
      *              *-------------------------------------------------*
           move      "#"                  to   rf-mms-flg-zer         .
      *              *-------------------------------------------------*
      *              * Update record                                   *
      *              *-------------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Routine di scrittura record [hdr] normalizzato            *
      *    *-----------------------------------------------------------*
       nor-rec-hdr-000.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Routine di scrittura record [mau] normalizzato            *
      *    *-----------------------------------------------------------*
       nor-rec-mau-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione record                          *
