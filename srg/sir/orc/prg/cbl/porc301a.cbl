      ...
      *                                                                *
      *                    SU MISURA PER SIRI - Distinta conferme via  *
      *                                         mail                   *
      *                                                                *
      *                                       - Controllo accesso      *
      *                                         agenti                 *
      ...
      *        *-------------------------------------------------------*
      *        * Work per Det contatore di invio tramite mail          *
      *        *-------------------------------------------------------*
           05  w-det-prt-eml.
               10  w-det-prt-eml-prt      pic  9(11)                  .
               10  w-det-prt-eml-dst      pic  9(09)                  .
               10  w-det-prt-eml-ele      pic  9(03)                  .
      ...
      *              *-------------------------------------------------*
      *              * Determinazione se presenti conferme ordine via  *
      *              * mail                                            *
      *              *                                                 *
      *              * SIRI                                            *
      *              *-------------------------------------------------*
           move      rf-oct-num-prt       to   w-det-prt-eml-prt      .
           perform   det-prt-eml-000      thru det-prt-eml-999        .
      *              *-------------------------------------------------*
      *              * Determinazione numero linee residue necessarie  *
      *              * in funzione della presenza del commento e di    *
      *              * numeri distinta mail                            *
      *              *                                                 *
      *              * SIRI                                            *
      *              *-------------------------------------------------*
           ...
           if        rf-oct-com-rig (3)   not  = spaces
                     add    1             to   w-tst-lin-res-num      .
           if        w-det-prt-eml-ele    >    zero
                     add    1             to   w-tst-lin-res-num      .
      *              *-------------------------------------------------*
      *              * Correttivo per residuo ordine                   *
      *              *-------------------------------------------------*
           if        w-det-tot-res-tot    =    zero
                     go to qry-liv-det-040.
           if        d-sts-orc-sts-ord    not  = 02
                     go to qry-liv-det-040.
           if        w-det-tot-res-tot    not  < w-det-tot-doc-tot
                     go to qry-liv-det-040.
           add       1                    to   w-tst-lin-res-num      .
       qry-liv-det-040.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      55                   to   v-pos                  .
           move      d-sts-orc-sts-lit    to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-400.
      *                  *---------------------------------------------*
      ...
      *                          *-------------------------------------*
           ...
           move      rf-oct-dec-vpf       to   v-dec                  .
           move      "S"                  to   v-sgn                  .
           move      w-det-tot-res-tot    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                          *-------------------------------------*
      *                          * Composizione                        *
      ...
      *                      *-----------------------------------------*
       ...
       qry-liv-det-500.
      *                  *---------------------------------------------*
      *                  * Distinta ultimo invio via mail              *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se da stampare                     *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Editing numero distina              *
      *                          *-------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "P"                  to   v-tip                  .
           move      06                   to   v-car                  .
           move      "<B"                 to   v-edm                  .
           move      w-det-prt-eml-dst    to   v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                          *-------------------------------------*
      *                          * Composizione                        *
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Numero   Data      Rif. Cliente      Importo total
      -              "e           Annotazioni       "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      ...
      *    *===========================================================*
      *    * Determinazione se ordine in distinta di invio tramite     *
      *    * mail                                                      *
      *    *-----------------------------------------------------------*
       det-prt-eml-000.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-prt-eml-ele      .
           move      zero                 to   w-det-prt-eml-dst      .
       det-prt-eml-100.
      *              *-------------------------------------------------*
      *              * Start su [oce]                                  *
      *              *-------------------------------------------------*
           ...
           move      w-det-prt-eml-prt    to   rf-oce-prt-doc         .
      ...
      *              * Test sul massimo                                *
      *              *-------------------------------------------------*
           if        rf-oce-prt-doc       not  = w-det-prt-eml-prt
                     go to det-prt-eml-900.
       det-prt-eml-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *                  * Test se inviato                             *
      *                  *---------------------------------------------*
           if        rf-oce-dat-inv       =    zero
                     go to det-prt-eml-200.
       det-prt-eml-600.
      *              *-------------------------------------------------*
      *              * Incremento contatore                            *
      *              *-------------------------------------------------*
           if        rf-oce-num-dst       =    w-det-prt-eml-dst
                     go to det-prt-eml-200.
           add       1                    to   w-det-prt-eml-ele      .
      *              *-------------------------------------------------*
      *              * Aggiornamento comodo di rottura protocollo      *
      *              * distinta                                        *
      *              *-------------------------------------------------*
           move      rf-oce-num-dst       to   w-det-prt-eml-dst      .
       det-prt-eml-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
