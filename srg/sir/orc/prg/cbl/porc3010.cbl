      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase orc301, nella sua globalita', esegue i tipi di inter-  *
      ...
      * INTDDR      Ricerca documenti per data di registrazione   301b *
      * INTDPV      Ricerca documenti per prodotto di vendita     301c *
      * LISOCD      Lista dettagliata ordini clienti              301f *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    INTERROGAZIONI SU ORDINI CLIENTI    "       .
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'orc301'           *
      *              *-------------------------------------------------*
           perform   fas-orc-301-000      thru fas-orc-301-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      ...
      -              " INTDPV     porc301c  "
           ...
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
       loa-tbl-tin-140.
           move      "Lista dettagliata ordini cliente         
      -              " LISOCD     porc301f  "
                                          to   w-tin-ele-wci          .
           perform   loa-tbl-ele-000      thru loa-tbl-ele-999        .
      *
      ...
      *    *-----------------------------------------------------------*
       ipc-snx-exp-000.
      *              *-------------------------------------------------*
      *              * Estrazione della variabile 'snx-exp' dal livel- *
      *              * lo precedente                                   *
      *              *-------------------------------------------------*
           move      "CV"                 to   s-ope                  .
      ...
      *    *===========================================================*
      *    * Esecuzione ciclo per la fase 'orc300'                     *
      *    *-----------------------------------------------------------*
       fas-orc-301-000.
      *              *-------------------------------------------------*
      *              * Video in Off                                    *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-orc-301-300
           else if   v-key                =    "PRSC"
                     go to fas-orc-301-400
           else if   v-key                =    "NXSC"
                     go to fas-orc-301-450
           else if   v-key                =    "DOWN"
                     go to fas-orc-301-500
           else if   v-key                =    "EXIT"
                     go to fas-orc-301-250
           else      go to fas-orc-301-200.
       fas-orc-301-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-orc-301-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-orc-301-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-orc-301-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-orc-301-350
           else      go to fas-orc-301-322.
       fas-orc-301-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-orc-301-630
           else if   v-key                =    "PRSC"
                     go to fas-orc-301-600
           else if   v-key                =    "NXSC"
                     go to fas-orc-301-610
           else if   v-key                =    "UP  "
                     go to fas-orc-301-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-orc-301-650
           else if   v-key                =    "EXIT"
                     go to fas-orc-301-660
           else      go to fas-orc-301-570.
       fas-orc-301-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-orc-301-626
           else      go to fas-orc-301-628.
       fas-orc-301-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-orc-301-636
           else      go to fas-orc-301-638.
       fas-orc-301-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-orc-301-725
           else      go to fas-orc-301-750.
       fas-orc-301-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Scrittura della variabile di i.p.c. relativa    *
      *              * all'ammissibilita' del tasto di funzione Expd,  *
      ...
      *                  *---------------------------------------------*
           ...
           move      "A"                  to   s-tip                  .
           move      01                   to   s-car                  .
           move      w-ipc-snx-exp-val    to   s-alf                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
       ric-pgm-exe-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       ric-pgm-exe-600.
      *              *-------------------------------------------------*
      *              * Richiamo programma tramite filtro               *
      *              *-------------------------------------------------*
