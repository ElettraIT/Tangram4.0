      ...
      *                       Ultima revisione:    001 del 23/05/05    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzione date righe ordini fornitori    *
      *                                                                *
      *                    SIRI                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "MANUTENZIONE DATE RIGHE ORDINI FORNITORI"       .
      ...
      *                *-----------------------------------------------*
                   ...
                   15  filler             pic  x(04)                  .
                   15  w-lin-imm-qta-ord  pic  x(15)                  .
                   15  filler             pic  x(06)                  .
                   15  w-lin-imm-flg-cnf  pic  x(01)                  .
                   15  filler             pic  x(01)                  .
                   15  w-lin-imm-dcn-prv  pic  x(08)                  .
                   15  filler             pic  x(02)                  .
                   15  w-lin-imm-dcn-cnf  pic  x(08)                  .
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [ofr]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-ofr.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-ofr-prt      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
               10  w-cmp-rec-ofr-prg      pic  9(05)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-det-sel-ofr.
               10  w-det-sel-ofr-inc      pic  9(11)                  .
               10  w-det-sel-ofr-sdo      pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-dcf                 .
      *              *-------------------------------------------------*
      *              * Close modulo determinazione status ordine       *
      *              *-------------------------------------------------*
      ...
      *                  * Si/no solo inevasi                          *
      *                  *---------------------------------------------*
           perform   acc-snx-ine-000      thru acc-snx-ine-999        .
           if        w-cnt-tus-acc-key    =    "E"
                     move  spaces         to   w-cnt-tus-acc-key
                     go to acc-key-reg-100.
           if        w-cnt-tus-acc-key    not  = spaces
      ...
      *              * Si/no solo inevasi                              *
      *              *-------------------------------------------------*
           perform   vis-snx-ine-000      thru vis-snx-ine-999        .
       vis-key-reg-999.
           exit.
      ...
      *                  * Si/no solo inevasi                          *
      *                  *---------------------------------------------*
           perform   pmt-snx-ine-000      thru pmt-snx-ine-999        .
       pmt-key-reg-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per : Si/no solo inevasi          *
      *    *-----------------------------------------------------------*
       pmt-snx-ine-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      w-tes-cod-arc        to   w-let-arc-dcf-fnt      .
      ...
      *    *===========================================================*
      *    * Visualizzazione campo : Ragione sociale archivio          *
      *    *-----------------------------------------------------------*
       vis-cod-arc-rag-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           perform   fnd-arc-ofr-000      thru fnd-arc-ofr-999        .
      ...
      *    *===========================================================*
      *    * Accettazione : Si/no solo inevasi                         *
      *    *-----------------------------------------------------------*
       acc-snx-ine-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-ine-lun    to   v-car                  .
           move      w-exp-snx-ine-num    to   v-ldt                  .
           move      "ST#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      w-exp-snx-ine-tbl    to   v-txt                  .
           move      "DOWN"               to   v-pfk (02)             .
           move      "DO  "               to   v-pfk (05)             .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-tes-snx-ine        to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-snx-ine-999.
       acc-snx-ine-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   w-tes-snx-ine          .
       acc-snx-ine-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-tes-snx-ine        not  = 01 and
                     w-tes-snx-ine        not  = 02
                     go to acc-snx-ine-100.
       acc-snx-ine-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Si/no solo inevasi                      *
      *    *-----------------------------------------------------------*
       vis-snx-ine-000.
           move      "DS"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
      ...
      *                  * Data confermata                             *
      *                  *---------------------------------------------*
           perform   acc-dcn-cnf-000      thru acc-dcn-cnf-999        .
           if        w-cnt-tus-acc-rig    not  = spaces
      ...
      *                  * Codice prodotto                             *
      *                  *---------------------------------------------*
           move      rf-ofr-alf-mag       to   w-lin-imm-alf-mag      .
       vis-lin-cor-490.
      *                  *---------------------------------------------*
      *                  * Editing quantita'                           *
      *                  *---------------------------------------------*
      ...
      *                  * Flag conferma                               *
      *                  *---------------------------------------------*
           move      rf-ofr-flg-cnf       to   w-lin-imm-flg-cnf      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-dcn-cnf      .
       vis-lin-cor-800.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.    Fornitore      Prodotto            Quanti
      -              "ta'       F Prevista  Interna "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *              * Data consegna confermata                        *
      *              *-------------------------------------------------*
           perform   vis-dcn-cnf-000      thru vis-dcn-cnf-999        .
      *              *-------------------------------------------------*
      *              * Estremi documento                               *
      *              *-------------------------------------------------*
      ...
      *              * Data consegna confermata                        *
      *              *-------------------------------------------------*
           perform   pmt-dcn-cnf-000      thru pmt-dcn-cnf-999        .
      *              *-------------------------------------------------*
      *              * Estremi documento                               *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Data consegna confermata         *
      *    *-----------------------------------------------------------*
       pmt-dcn-cnf-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data consegna confermata             *
      *    *-----------------------------------------------------------*
       acc-dcn-cnf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-rig
                     go to acc-dcn-cnf-999.
      *              *-------------------------------------------------*
      *              * Valore impostato                                *
      *              *-------------------------------------------------*
           move      v-dat                to   w-rig-dcn-cnf          .
       acc-dcn-cnf-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-rig-flg
                             ...
                             go to acc-dcn-cnf-100.
       acc-dcn-cnf-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo : Data consegna confermata          *
      *    *-----------------------------------------------------------*
       vis-dcn-cnf-000.
           move      "DS"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-ofr-tmo-orf       to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-rig-100.
      *              *-------------------------------------------------*
      *              * Controllo su data consegna confermata           *
      *              *-------------------------------------------------*
           if        w-rig-dcn-cnf        not  = zero
                     go to cnt-tdo-rig-800.
           move      "Manca la data interna !                           
      -              "               "    to   w-err-box-err-msg      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-dat-min        to   rf-oft-dat-doc         .
           move      w-tes-dpz-inu        to   rf-oft-cod-dpz         .
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-ofr-dat-doc       >    w-tes-dat-min
      ...
      *                  *---------------------------------------------*
           if        rf-ofr-dat-doc       >    w-tes-dat-max
                     go to stp-srt-inp-900.
           go to     stp-srt-inp-400.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-oft-cod-dpz       not  = w-tes-dpz-inu
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-oft-cod-arc       not  = w-tes-cod-arc
                     go to stp-srt-inp-200.
       stp-srt-inp-460.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-oft-tmo-orf       not  = w-tes-tip-mov
                     go to stp-srt-inp-200.
       stp-srt-inp-480.
      *                  *---------------------------------------------*
      *                  * Test su stato ordine                        *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test                                    *
      *                      *-----------------------------------------*
      ...
      *                      * Codice archivio                         *
      *                      *-----------------------------------------*
           move      rf-ofr-cod-arc       to   srt-cod-arc            .
      *                      *-----------------------------------------*
      *                      * Data documento                          *
      *                      *-----------------------------------------*
      ...
      *                  * Record [ofr]                                *
      *                  *---------------------------------------------*
           move      rf-ofr               to   w-rig-rec-ofr          .
           move      rf-ofr-cod-arc       to   w-rig-cod-arc          .
           move      rf-ofr-dpz-arc       to   w-rig-dpz-arc          .
      ...
      *              *-------------------------------------------------*
           move      w-rig-rec-ofr        to   rf-ofr                 .
           move      rf-ofr-num-prt       to   w-cmp-rec-ofr-prt      .
           move      rf-ofr-num-prg       to   w-cmp-rec-ofr-prg      .
       sca-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-cmp-rec-ofr-prt    to   rf-ofr-num-prt         .
           move      w-cmp-rec-ofr-prg    to   rf-ofr-num-prg         .
           move      "pgm/orf/fls/ioc/obj/iofofr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
      *                  * Aggiornamento data richiesta confermata     *
      *                  *---------------------------------------------*
           move      w-rig-dcn-cnf        to   rf-ofr-dcn-cnf         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [ofr]                         *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "sir/agb/prg/obj/pagb9302"                       .
       cnc-rlt-sup-999.
           exit.
