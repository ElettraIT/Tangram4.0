      ...
      *                                   Fase:    agb650              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 20/04/22    *
      *                       Ultima revisione:    NdK del 29/07/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Sistemazione [her] - file di appoggio EDI   *
      *                                                                *
      *                    Flag 'rf-her-flg-car' a '#' per un          *
      *                    singolo file con aggiornamento MySQL        *
      *                    (da verificare nel database)                *
      *                                                                *
      *                    SIRI                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Codice identificatore del record                  *
      *            *---------------------------------------------------*
               10  srt-pth-edi            pic  x(40)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   ANNULLAMENTO MANUALE CONFERME 'EDI'  "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           ...
           05  rr-sgl-fnt                     pic  x(03)              .
           05  rr-dat-cnf                     pic  9(07)              .
           05  rr-sgl-sub                     pic  x(04)              .
           05  rr-prg-alf                     pic  x(04)              .
           05  rr-pth-mod                     pic  x(40)              .
           ...
           05  w-exp-tip-cnv.
               ...
               10  w-exp-tip-cnv-tbl.
                   15  filler             pic  x(40) value
                          "Annullamento manuale singola conferma   "  .
      *        *-------------------------------------------------------*
      *        * Work per : Sigla fornitore                            *
      *        *-------------------------------------------------------*
           05  w-exp-sgl-fnt.
               10  w-exp-sgl-fnt-num      pic  9(02)       value 03   .
               10  w-exp-sgl-fnt-lun      pic  9(02)       value 03   .
               10  w-exp-sgl-fnt-tbl.
                   15  filler             pic  x(03) value "MOL"      .
                   15  filler             pic  x(03) value "VIS"      .
                   15  filler             pic  x(03) value "YAG"      .
      ...
      *                  * Sigla fornitore                             *
      *                  *---------------------------------------------*
           perform   acc-sgl-fnt-000      thru acc-sgl-fnt-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Data conferma                               *
      *                  *---------------------------------------------*
           perform   acc-dat-cnf-000      thru acc-dat-cnf-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Sub-sigla                                   *
      *                  *---------------------------------------------*
           perform   acc-sgl-sub-000      thru acc-sgl-sub-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-500.
      *                  *---------------------------------------------*
      *                  * Progressivo alfanumerico                    *
      *                  *---------------------------------------------*
           perform   acc-prg-alf-000      thru acc-prg-alf-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
       ...
       acc-ric-sel-600.
      *                  *---------------------------------------------*
      *                  * Pathname da modificare                      *
      *                  *---------------------------------------------*
           perform   acc-pth-mod-000      thru acc-pth-mod-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      10                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Data arrivo file conferma  :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Sigla fornitore                      *
      *    *-----------------------------------------------------------*
       acc-sgl-fnt-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-sgl-fnt-lun    to   v-car                  .
           move      w-exp-sgl-fnt-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      "MVY#"               to   v-msk                  .
           move      w-exp-sgl-fnt-tbl    to   v-txt                  .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           move      08                   to   v-lin                  .
      ...
      *
           if        rr-sgl-fnt           =    "MOL"
                     move  01             to   v-num
           else if   rr-sgl-fnt           =    "VIS"
                     move  02             to   v-num
           else if   rr-sgl-fnt           =    "YAG"
                     move  03             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-sgl-fnt-999.
       acc-sgl-fnt-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "MOL"          to   rr-sgl-fnt
           else if   v-num                =    02
                     move  "VIS"          to   rr-sgl-fnt
           else if   v-num                =    03
                     move  "YAG"          to   rr-sgl-fnt
           else      move  spaces         to   rr-sgl-fnt             .
       acc-sgl-fnt-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-sgl-fnt           =    zero
                     go to acc-sgl-fnt-100.
       acc-sgl-fnt-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Data conferma                        *
      *    *-----------------------------------------------------------*
       acc-dat-cnf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-dat-cnf-999.
       acc-dat-cnf-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-dat                to   rr-dat-cnf             .
       acc-dat-cnf-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-dat-cnf-100.
       acc-dat-cnf-999.
           exit.

      *    *===========================================================*
      *    * Accettazione campo : Sub-sigla                            *
      *    *-----------------------------------------------------------*
       acc-sgl-sub-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        rr-sgl-sub           =    spaces
                     move  "A001"         to   rr-sgl-sub             .
       acc-sgl-sub-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-sgl-sub-999.
       acc-sgl-sub-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-sgl-sub             .
       acc-sgl-sub-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-sgl-sub-100.
       acc-sgl-sub-999.
           exit.

      *    *===========================================================*
      *    * Accettazione campo : Progressivo alfanumerico             *
      *    *-----------------------------------------------------------*
       acc-prg-alf-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  * Eventuale default                           *
      *                  *---------------------------------------------*
           if        rr-prg-alf           =    spaces
                     move  "DXXX"         to   rr-prg-alf             .
       acc-prg-alf-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-prg-alf-999.
       acc-prg-alf-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-prg-alf             .
       acc-prg-alf-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Assemblaggio parametri precedenti           *
      *                  *---------------------------------------------*
           perform   acc-pth-mod-ass-000  thru acc-pth-mod-ass-999    .
       acc-pth-mod-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-pth-mod-999.
       acc-pth-mod-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-pth-mod             .
       acc-pth-mod-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *    * Accettazione : Numero documento da ricercare              *
      *    *                                                           *
      *    * Subroutine di assemblaggio del nome file                  *
      *    *-----------------------------------------------------------*
       acc-pth-mod-ass-000.
      *              *-------------------------------------------------*
      *              * Editing anno data conferma                      *
      *              *-------------------------------------------------*
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      04                   to   p-car                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      "RSP_"               to   w-all-str-cat (01)     .
           move      rr-sgl-fnt           to   w-all-str-cat (02)     .
           move      "_"                  to   w-all-str-cat (03)     .
           move      "_"                  to   w-all-str-cat (07)     .
           move      rr-sgl-sub           to   w-all-str-cat (08)     .
           move      rr-prg-alf           to   w-all-str-cat (09)     .
           move      ".CSV.ok"            to   w-all-str-cat (10)     .
           perform   all-str-cat-000      thru all-str-cat-999        .
           move      w-all-str-alf        to   rr-pth-mod             .
       acc-pth-mod-ass-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     acc-pth-mod-ass-999.
       acc-pth-mod-ass-999.
           exit.
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      spaces               to   rr-sgl-fnt             .
           move      spaces               to   rr-sgl-sub             .
           move      zero                 to   rr-dat-cnf             .
           move      spaces               to   rr-prg-alf             .
           move      spaces               to   rr-pth-mod             .
       nor-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Controllo su nome file da annullare             *
      *              *-------------------------------------------------*
           if        rr-pth-mod           not  = spaces
                     go to tdo-ric-sel-800.
           move      "Manca il nome della conferma da cancellare !"
      ...
      *              * Ciclo per [her]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-her-000  thru stp-srt-inp-her-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-her-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [her]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "PTHPRG    "         to   f-key                  .
           move      rr-pth-mod           to   rf-her-pth-edi         .
      ...
      *                  *---------------------------------------------*
           if        f-sts                not  = e-not-err
                     go to stp-srt-inp-her-900.
       stp-srt-inp-her-200.
      *              *-------------------------------------------------*
      *              * Read-next su archivio [her]                     *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "sir/agb/fls/ioc/obj/iofher"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su Pathname univoco file EDI           *
      *                  *---------------------------------------------*
           if        rf-her-pth-edi       not  = rr-pth-mod
                     go to stp-srt-inp-her-900.
       stp-srt-inp-her-400.
      *              *-------------------------------------------------*
      *              * Selezioni sul record [her]                      *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test su flag di conferma caricata           *
      *                  *---------------------------------------------*
           if        rf-her-flg-car       not  = spaces
                     go to stp-srt-inp-her-200.
       stp-srt-inp-her-600.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave per il sort                          *
      *                  *---------------------------------------------*
           move      rf-her-pth-edi       to   srt-pth-edi            .
           move      rf-her-prg-inp       to   srt-prg-inp            .
      *                  *---------------------------------------------*
      *                  * Dati per il sort                            *
      *                  *---------------------------------------------*
           move      rf-her               to   srt-rec-her            .
       stp-srt-inp-her-700.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   agg-rec-her-000      thru agg-rec-her-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Aggiornamento record [her]                                *
      *    *-----------------------------------------------------------*
       agg-rec-her-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione record [her]                    *
      *              *-------------------------------------------------*
           move      "NO"                 to   f-ope                  .
           move      "sir/agb/fls/ioc/obj/iofher"
                                          to   s-pat                  .
      ...
      *              *-------------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "PTHPRG    "         to   f-key                  .
           move      srt-pth-edi          to   rf-her-pth-edi         .
           move      srt-prg-inp          to   rf-her-prg-inp         .
           move      "sir/agb/fls/ioc/obj/iofher"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *              *-------------------------------------------------*
           ...
           string    "mysql -u root -p"
                     ...
                     w-all-str-cat (1)
                                delimited by   spaces
                     " -e ""UPDATE siri.retarus SET flag ='#' WHERE "
                                delimited by   size
                     "path = '"
                                delimited by   size
                     rr-pth-mod
