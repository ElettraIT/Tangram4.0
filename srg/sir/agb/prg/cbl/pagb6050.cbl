      ...
      *                                   Fase:    agb605              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 11/04/96    *
      *                       Ultima revisione:    NdK del 05/03/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione dati aggiuntivi archivio fornitori *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   DATI ARCHIVIO FORNITORI PER EXPORT   "       .
      ...
      *                  *---------------------------------------------*
           move      rf-fnt-rag-soc       to   w-tes-cod-fnt-rag      .
      ...
      *                  * Stringa per EDI                             *
      *                  *---------------------------------------------*
           perform   acc-str-edi-000      thru acc-str-edi-999        .
           if        v-key                =    "NXSC"
      ...
      *              * Stringa per EDI                                 *
      *              *-------------------------------------------------*
           perform   vis-str-edi-000      thru vis-str-edi-999        .
           go to     vis-tes-reg-999.
       vis-tes-reg-999.
           exit.
      ...
      *              * Stringa per EDI                                 *
      *              *-------------------------------------------------*
           perform   pmt-str-edi-000      thru pmt-str-edi-999        .
           go to     pmt-tes-reg-999.
       pmt-tes-reg-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione prompt : Stringa per EDI                  *
      *    *-----------------------------------------------------------*
       pmt-str-edi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Stringa per EDI              *
      *    *-----------------------------------------------------------*
       acc-str-edi-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *                  *---------------------------------------------*
           if        w-tes-str-edi (1)    not  = spaces
                     go to acc-str-edi-450.
           if        v-key                =    "UP  "
                     go to acc-str-edi-600
           else      go to acc-str-edi-100.
       acc-str-edi-450.
       acc-str-edi-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-nok-flg
                             ...
                             go to acc-str-edi-100.
       acc-str-edi-999.
           exit.

      *    *===========================================================*
      *    * Visualizzazione campo testata : Stringa per EDI           *
      *    *-----------------------------------------------------------*
       vis-str-edi-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
       ...
       cnt-tdo-nok-100.
      *              *-------------------------------------------------*
      *              * Controllo su Stringa per EDI                    *
      *              *-------------------------------------------------*
           if        w-tes-str-edi (1)    not  = spaces
                     go to cnt-tdo-nok-200.
           move      "Manca la stringa alfanumerica                   "
      ...
      *    *-----------------------------------------------------------*
       nor-nok-tes-000.
           move      spaces               to   w-tes-str-edi (1)      .
      ...
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODFNT    "         to   f-key                  .
           move      w-tes-cod-fnt        to   rf-hfe-cod-fnt         .
           move      "sir/agb/fls/ioc/obj/iofhfe"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      *-----------------------------------------*
           move      rf-hfe-str-edi       to   w-tes-str-edi (1)      .
           move      rf-hfe-alx-exp       to   w-tes-alx-exp (1)      .
       rou-let-reg-300.
      *                      *-----------------------------------------*
      ...
      *                      * Write record [hfe]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-hfe-000      thru wrt-rec-hfe-999        .
      ...
      *                      * Rewrite record [hfe]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-hfe-000      thru rew-rec-hfe-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [hfe]                             *
      *              *-------------------------------------------------*
           perform   del-rec-hfe-000      thru del-rec-hfe-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Composizione record [hfe]                                 *
      *    *-----------------------------------------------------------*
       cmp-rec-hfe-000.
      *              *-------------------------------------------------*
      ...
      *                  * Campi non chiave                            *
      *                  *---------------------------------------------*
           move      w-tes-str-edi (1)    to   rf-hfe-str-edi         .
           move      w-tes-alx-exp (1)    to   rf-hfe-alx-exp         .
       cmp-rec-hfe-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record [hfe]                                    *
      *    *-----------------------------------------------------------*
       wrt-rec-hfe-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-hfe-000      thru cmp-rec-hfe-999        .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
