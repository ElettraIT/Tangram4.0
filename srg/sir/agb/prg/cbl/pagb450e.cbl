      ...
      *                       Ultima revisione:    NdK del 26/12/20    *
      *                    ------------------------------------------- *
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Cancellazione record distinta                   *
      *              *-------------------------------------------------*
           perform   del-rec-dst-000      thru del-rec-dst-999        .
       prn-liv-det-999.
           exit.
      ...
      *    *===========================================================*
      *    * Cancellazione record [hpo]                                *
      *    *-----------------------------------------------------------*
       del-rec-dst-000.
      *              *-------------------------------------------------*
      *              * Composizione chiave primaria                    *
      *              *-------------------------------------------------*
           move      srt-pth-pos          to   rf-hpo-pth-pos         .
           move      srt-prg-inp          to   rf-hpo-prg-inp         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
