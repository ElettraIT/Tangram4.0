      ...
      *                       Ultima revisione:    NdK del 26/03/02    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pagb4601:        *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-gia.
               10  w-exp-tip-gia-num      pic  9(02)       value 4    .
               10  w-exp-tip-gia-lun      pic  9(02)       value 15   .
      ...
      *        *-------------------------------------------------------*
           05  w-exp-tip-val.
               10  w-exp-tip-val-num      pic  9(02)       value 5    .
               10  w-exp-tip-val-lun      pic  9(02)       value 30   .
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Si/no solo se non valorizzati              *
      *        *-------------------------------------------------------*
           05  w-exp-snx-nvl.
               10  w-exp-snx-nvl-num      pic  9(02)       value 2    .
               10  w-exp-snx-nvl-lun      pic  9(02)       value 02   .
      ...
      *              *-------------------------------------------------*
           if        v-num                =    01
                     ...
                     move  02             to   rr-tip-val
           else if   v-num                =    03
                     move  03             to   rr-tip-val
           else if   v-num                =    04
                     move  04             to   rr-tip-val
           else if   v-num                =    05
                     move  51             to   rr-tip-val
           else      move  zero           to   rr-tip-val             .
       acc-tip-val-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
