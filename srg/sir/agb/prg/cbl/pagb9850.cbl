      ...
      *                       Ultima revisione:    NdK del 25/09/98    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    Update clienti commerciali per codice       *
      *                    vettore                                     *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   AGGIORNAMENTO CODICE VETTORE - SIRI  "       .
      ...
      *    *-----------------------------------------------------------*
       01  rr.
           05  rr-vet-sel                     pic  9(07)              .
           05  rr-vet-sos                     pic  9(07)              .
           05  rr-vet-slt                     pic  x(04)              .
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-150.
      *                  *---------------------------------------------*
      *                  * Codice vettore da selezionare               *
      *                  *---------------------------------------------*
           perform   acc-vet-sel-000      thru acc-vet-sel-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
       acc-ric-sel-200.
      *                  *---------------------------------------------*
      *                  * Codice vettore da sostituire                *
      *                  *---------------------------------------------*
           perform   acc-vet-sos-000      thru acc-vet-sos-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Selettore                                   *
      *                  *---------------------------------------------*
           perform   acc-vet-slt-000      thru acc-vet-slt-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice vettore da selezionare        *
      *    *-----------------------------------------------------------*
       acc-vet-sel-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-vet-sel-999.
       acc-vet-sel-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-vet-sel             .
       acc-vet-sel-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-vet-sel           =    zero
                     go to acc-vet-sel-100.
       acc-vet-sel-600.
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Accettazione campo : Codice vettore da sostituire         *
      *    *-----------------------------------------------------------*
       acc-vet-sos-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-vet-sos-999.
       acc-vet-sos-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-vet-sos             .
       acc-vet-sos-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-vet-sos           =    zero
                     go to acc-vet-sos-100.
       acc-vet-sos-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-vet-slt-999.
       acc-vet-slt-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   rr-vet-slt             .
       acc-vet-slt-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-vet-slt           =    spaces
                     go to acc-vet-slt-100.
       acc-vet-slt-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           move      zero                 to   rr-vet-sel             .
           move      zero                 to   rr-vet-sos             .
           move      spaces               to   rr-vet-slt             .
       nor-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        w-wrk-ctr-001        not  > zero
                     move "Nessun aggiornamento eseguito"
                                          to   m-msg
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-100.
      *              *-------------------------------------------------*
      *              * Test su codice vettore - porto                  *
      *              *-------------------------------------------------*
           if        rf-dcc-cod-vet       not  = rr-vet-sel
                     go to prn-liv-det-300.
           if        rf-dcc-vde-cod (2)   not  = rr-vet-slt
                     go to prn-liv-det-300.
       prn-liv-det-150.
      *              *-------------------------------------------------*
      *              * Aggiornamento codice vettore                    *
      *              *-------------------------------------------------*
           move      rr-vet-sos           to   rf-dcc-cod-vet         .
       prn-liv-det-200.
      *              *-------------------------------------------------*
      *              * Update record [dcc]                             *
      *              *-------------------------------------------------*
