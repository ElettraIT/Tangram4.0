      ...
      *                       Ultima revisione:    NdK del 07/11/08    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Estrazione statistiche per BCC              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "ESTRAZIONE STATISTICHE DA FATTURATO BCC "       .
      ...
      *        *-------------------------------------------------------*
           05  w-fat-rag-cli              pic  x(30)                  .
      *        *-------------------------------------------------------*
      *        * Indirizzo cliente                                     *
      *        *-------------------------------------------------------*
           05  w-fat-via-cli              pic  x(30)                  .
      *        *-------------------------------------------------------*
      *        * CAP cliente                                           *
      *        *-------------------------------------------------------*
           05  w-fat-cap-cli              pic  x(05)                  .
      *        *-------------------------------------------------------*
      *        * Localita' cliente                                     *
      *        *-------------------------------------------------------*
           05  w-fat-loc-cli              pic  x(30)                  .
      *        *-------------------------------------------------------*
      *        * Codice nazione cliente                                *
      *        *-------------------------------------------------------*
           05  w-fat-naz-cli              pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Data (GGMMAA)                                         *
      *        *-------------------------------------------------------*
           05  w-fat-dat-doc.
               10  w-fat-gio-doc          pic  x(02)                  .
               10  w-fat-mes-doc          pic  x(02)                  .
               10  w-fat-ann-doc          pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice del prodotto per la casa produttrice           *
      *        *-------------------------------------------------------*
           05  w-fat-cdp-pdt              pic  x(20)                  .
      *        *-------------------------------------------------------*
      *        * Segno quantita' (+/-)                                 *
      *        *-------------------------------------------------------*
           05  w-fat-sgn-qta              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' (12 interi)                                 *
      *        *-------------------------------------------------------*
           05  w-fat-qta-ven              pic  x(12)                  .
      *        *-------------------------------------------------------*
      *        * Segno valore (+/-)                                    *
      *        *-------------------------------------------------------*
           05  w-fat-sgn-val              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Valore (10 interi, 2 decimali)                        *
      *        *-------------------------------------------------------*
           05  w-fat-tot-val              pic  x(12)                  .
      *        *-------------------------------------------------------*
      *        * Codice valuta                                         *
      *        *-------------------------------------------------------*
           05  w-fat-sgl-vpf              pic  x(03)                  .
      *        *-------------------------------------------------------*
      *        * Carattere per CR + LF                                 *
      *        *-------------------------------------------------------*
           05  w-fat-chr-end              pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "PORTANTE !).            "
                                          to   v-nt1                  .
           move      "(Es.: per BCC indicare la classe 200 (premere F3 e
      ...
      *              *-------------------------------------------------*
           move      "NT"                 to   v-ope                  .
           move      "Indicare il nome senza il suffisso (Es.: BCC)"
                                          to   v-nt1                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *              *-------------------------------------------------*
      ...
      *                  * Codice del prodotto per la casa produttrice *
      *                  *---------------------------------------------*
           move      rf-aaq-cdp-pdt       to   w-fat-cdp-pdt          .
       crz-arc-ven-630.
      *                  *---------------------------------------------*
      *                  * Codice categoria cliente (WWIC)             *
      *                  *---------------------------------------------*
       crz-arc-ven-640.
      *                  *---------------------------------------------*
      *                  * Data (GGMMAA)                               *
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-fat-ann-doc          .
       crz-arc-ven-650.
      *                  *---------------------------------------------*
      *                  * Segno quantita' (+/-)                       *
      *                  *---------------------------------------------*
           if        rf-fit-tip-doc       =    01
                     move  "+"            to   w-fat-sgn-qta
           else if   rf-fit-tip-doc       =    02
                     move  "+"            to   w-fat-sgn-qta
           else if   rf-fit-tip-doc       =    03
                     move  "-"            to   w-fat-sgn-qta
           else      move  "+"            to   w-fat-sgn-qta          .
       crz-arc-ven-660.
      *                  *---------------------------------------------*
      *                  * Quantita' di vendita                        *
      *                  *---------------------------------------------*
      ...
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      v-edt                to   w-fat-qta-ven          .
      *                      *-----------------------------------------*
      *                      * Allineamento a destra                   *
      *                      *-----------------------------------------*
           move      12                   to   w-all-str-lun          .
           move      w-fat-qta-ven        to   w-all-str-alf          .
           perform   all-str-adx-000      thru all-str-adx-999        .
           move      w-all-str-alf        to   w-fat-qta-ven          .
      *                      *-----------------------------------------*
      *                      * Riempimento con zeri                    *
      *                      *-----------------------------------------*
           inspect   w-fat-qta-ven
                                replacing all  " "
                                          by   "0"                    .
       crz-arc-ven-670.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-fit-tip-doc       =    01
                     move  "+"            to   w-fat-sgn-val
           else if   rf-fit-tip-doc       =    02
                     move  "+"            to   w-fat-sgn-val
           else if   rf-fit-tip-doc       =    03
                     move  "-"            to   w-fat-sgn-val
           else      move  "+"            to   w-fat-sgn-val          .
       crz-arc-ven-680.
      *                  *---------------------------------------------*
      ...
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      v-edt                to   w-fat-tot-val          .
      *                      *-----------------------------------------*
      *                      * Allineamento a destra                   *
      *                      *-----------------------------------------*
           move      12                   to   w-all-str-lun          .
           move      w-fat-tot-val        to   w-all-str-alf          .
           perform   all-str-adx-000      thru all-str-adx-999        .
           move      w-all-str-alf        to   w-fat-tot-val          .
      *                      *-----------------------------------------*
      *                      * Riempimento con zeri                    *
      *                      *-----------------------------------------*
           inspect   w-fat-tot-val
                                replacing all  " "
                                          by   "0"                    .
       crz-arc-ven-700.
      *                  *---------------------------------------------*
      *                  * Ragione sociale cliente                     *
      *                  *---------------------------------------------*
           move      rf-dcc-rag-soc       to   w-fat-rag-cli          .
       crz-arc-ven-710.
      *                  *---------------------------------------------*
      *                  * Codice nazione per Partita Iva              *
      *                  *---------------------------------------------*
           move      rf-dcc-cod-naz       to   w-fat-sgl-vpf          .
       crz-arc-ven-720.
      *                  *---------------------------------------------*
      *                  * Partita Iva                                 *
      *                  *---------------------------------------------*
      ...
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      w-scm-loc-ccp-cap    to   w-fat-cap-cli          .
       crz-arc-ven-740.
      *                  *---------------------------------------------*
      *                  * Localita' cliente                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Assemblaggio citta' e provincia         *
      *                      *-----------------------------------------*
           move      40                   to   w-all-str-lun          .
           move      02                   to   w-all-str-num          .
           move      w-scm-loc-ccp-cit    to   w-all-str-cat (1)      .
           move      w-scm-loc-ccp-prv    to   w-all-str-cat (2)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   w-fat-loc-cli          .
       crz-arc-ven-750.
      *                  *---------------------------------------------*
      *                  * Indirizzo cliente                           *
      *                  *---------------------------------------------*
           move      rf-dcc-via-dcc       to   w-fat-via-cli          .
       crz-arc-ven-750.
      *                  *---------------------------------------------*
      *                  * Codice nazione                              *
      *                  *---------------------------------------------*
           move      rf-dcc-cod-naz       to   w-fat-naz-cli          .
       crz-arc-ven-730.
      *                  *---------------------------------------------*
      *                  * Codice valuta                               *
      *                  *---------------------------------------------*
           move      "EUR"                to   w-fat-sgl-vpf          .
       crz-arc-ven-780.
      *                  *---------------------------------------------*
      *                  * Composizione carattere di fine record       *
      *                  *---------------------------------------------*
           move      w-gen-chr-end        to   w-fat-chr-end          .
       crz-arc-ven-800.
      *              *-------------------------------------------------*
