      ...
      *                                                                *
      *                    '/abd/asc/exp/NOMEFILE.csv'                 *
      *                                                                *
      *    +---------------+--------------------+--------------------+ *
      *    |  alf-pro (15) |     old-p/n (20)   |     new-p/n (20)   | *
      *    |    [3cm.]     |       [4cm.]       |       [4cm.]       | *
      *    +---------------+--------------------+--------------------+ *
      *    |XXXXXXXXXXXXXX |XXXXXXXXXXXXXXXXXXXX|XXXXXXXXXXXXXXXXXXXX| *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "AGGIORNAMENTO PART NUMBER DA FILE 'CSV' "       .
      ...
      *        *-------------------------------------------------------*
           05  w-rdp.
      *            *---------------------------------------------------*
      *            * Codice prodotto SIRI                              *
      *            *---------------------------------------------------*
               10  w-rdp-alf-pro          pic  x(15)                  .
      *            *---------------------------------------------------*
      *            * Codice prodotto per il fornitore - OLD            *
      *            *---------------------------------------------------*
               10  w-rdp-cod-old          pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Codice prodotto per il fornitore - NEW            *
      *            *---------------------------------------------------*
               10  w-rdp-cod-new          pic  x(20)                  .
      ...
      *                      *-----------------------------------------*
           ...
           move      "/abd/asc/exp/"      to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Estrazione dei 3 campi                      *
      *                  *---------------------------------------------*
           move      g-rec                to   w-rdp                  .
      *                  *---------------------------------------------*
      *                  * Allineamento a sinistra codice alfanumerico *
      *                  *---------------------------------------------*
           move      15                   to   w-all-str-lun          .
           move      w-rdp-alf-pro        to   w-all-str-alf          .
           perform   all-str-asx-000      thru all-str-asx-999        .
           move      w-all-str-alf        to   w-rdp-alf-pro          .
      *                  *---------------------------------------------*
      *                  * Determinazione codice numerico              *
      *                  *---------------------------------------------*
           move      w-rdp-alf-pro        to   w-det-num-pro-alf      .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rdp-alf-pro        to   w-all-str-cat (2)      .
           move      "- non trovato in anagrafica prodotti !"
                                          to   w-all-str-cat (3)      .
      ...
      *                  * Confronto PN old                            *
      *                  *---------------------------------------------*
           if        rf-aaq-cdp-pdt       =    w-rdp-cod-old
                     go to prn-liv-det-400.
      *                  *---------------------------------------------*
      *                  * Prodotto con PN old diverso                 *
      *                  *---------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      06                   to   w-all-str-num          .
           move      "Codice"             to   w-all-str-cat (1)      .
           move      w-rdp-alf-pro        to   w-all-str-cat (2)      .
           move      "- (old):"           to   w-all-str-cat (3)      .
           move      rf-aaq-cdp-pdt       to   w-all-str-cat (4)      .
           move      "- (new):"           to   w-all-str-cat (5)      .
           move      w-rdp-cod-new        to   w-all-str-cat (6)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-wrt-msg-err-msg      .
           perform   wrt-msg-err-000      thru wrt-msg-err-999        .
      ...
      *                  * Confronto PN new                            *
      *                  *---------------------------------------------*
           if        rf-aaq-cdp-pdt       not  = w-rdp-cod-new
                     go to prn-liv-det-600.
      *                  *---------------------------------------------*
      *                  * Attualmente nessun avviso                   *
      *                  *---------------------------------------------*
           go to     prn-liv-det-900.
      *                  *---------------------------------------------*
      *                  * Prodotto con PN new giˆ variato             *
      *                  *---------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      "Codice"             to   w-all-str-cat (1)      .
           move      w-rdp-alf-pro        to   w-all-str-cat (2)      .
           move      "- con Part Number gia' aggiornato !"
                                          to   w-all-str-cat (3)      .
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      w-all-str-alf        to   w-wrt-msg-err-msg      .
      ...
      *              *-------------------------------------------------*
           move      "AGGIORNAMENTO PART NUMBER"
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rdp-cod-new        to   w-all-str-cat (4)      .
      ...
      *                      * Part Number new                         *
      *                      *-----------------------------------------*
           move      w-rdp-cod-new        to   rf-aaq-cdp-pdt         .
      *                      *-----------------------------------------*
      *                      * Test se update da eseguire              *
      *                      *-----------------------------------------*
           if        rr-tip-exe           not  = 02
                     go to upd-rec-aaq-400.
      *                      *-----------------------------------------*
      *                      * Update record [aaq]                     *
      *                      *-----------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-tip-exe           =    01
                     move  "(prova) codice :"
                                          ...
                                          to   w-all-str-cat (1)      .
           move      w-rdp-alf-pro        to   w-all-str-cat (2)      .
           move      "- Nuovo PN."        to   w-all-str-cat (3)      .
           move      w-rdp-cod-new        to   w-all-str-cat (4)      .
      *
           perform   all-str-csb-000      thru all-str-csb-999        .
           move      w-all-str-alf        to   w-wrt-msg-err-msg      .
