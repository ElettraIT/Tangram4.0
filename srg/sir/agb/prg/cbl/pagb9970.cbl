      ...
      *                                   Fase:    orc997              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 10/05/04    *
      *                       Ultima revisione:    NdK del 26/11/04    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Gestione evasioni ordini 'forecast' clienti *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "GESTIONE EVASIONI FORECAST ORDINI CLIEN."       .
      ...
      *              * Pre-accettazione                                *
      *              *-------------------------------------------------*
           move      w-acc-tmo-orc        to   rf-oct-tmo-orc         .
       acc-tmo-orc-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Protocollo ordine forecast                      *
      *              *-------------------------------------------------*
           perform   vis-prt-frc-000      thru vis-prt-frc-999        .
      *              *-------------------------------------------------*
      *              * Progressivo riga ordine forecast                *
      *              *-------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Protocollo ordine forecast    *
      *    *-----------------------------------------------------------*
       pmt-prt-frc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompts per Progressivo ordine forecast   *
      *    *-----------------------------------------------------------*
       pmt-prg-frc-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      w-acc-num-prg        to   rf-ocr-num-prg         .
           move      "pgm/orc/fls/ioc/obj/iofocr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      rf-oct-num-prt       to   rf-ocf-num-prt         .
           move      w-acc-num-prg        to   rf-ocf-num-prg         .
           move      "pgm/orc/fls/ioc/obj/iofocf"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Write record [ocf]                      *
      *                      *-----------------------------------------*
           perform   wrt-rec-ocf-000      thru wrt-rec-ocf-999        .
      *                      *-----------------------------------------*
      *                      * Uscita                                  *
      *                      *-----------------------------------------*
      ...
      *                      * Rewrite record [ocf]                    *
      *                      *-----------------------------------------*
           perform   rew-rec-ocf-000      thru rew-rec-ocf-999        .
       scr-mov-fil-999.
           exit.
      ...
      *              * Delete record [ocf]                             *
      *              *-------------------------------------------------*
           perform   del-rec-ocf-000      thru del-rec-ocf-999        .
       del-mov-fil-999.
           exit.

      *    *===========================================================*
      *    * Cancellazione record righe [ocf]                          *
      *    *-----------------------------------------------------------*
       del-rec-ocf-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           perform   cmp-rec-ocf-000      thru cmp-rec-ocf-999        .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *    *===========================================================*
      *    * Composizione record righe [ocf]                           *
      *    *-----------------------------------------------------------*
       cmp-rec-ocf-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
           move      w-acc-num-prt        to   rf-ocf-num-prt         .
           move      w-acc-num-prg        to   rf-ocf-num-prg         .
           move      w-acc-tmo-orc        to   rf-ocf-tmo-orc         .
           move      w-acc-cod-dpz        to   rf-ocf-cod-dpz         .
           move      w-acc-dat-doc        to   rf-ocf-dat-doc         .
           move      w-acc-num-doc        to   rf-ocf-num-doc         .
           move      spaces               to   rf-ocf-alx-exp         .
       cmp-rec-ocf-999.
           exit.

      *    *===========================================================*
      *    * Scrittura record righe [ocf]                              *
      *    *-----------------------------------------------------------*
       wrt-rec-ocf-000.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
