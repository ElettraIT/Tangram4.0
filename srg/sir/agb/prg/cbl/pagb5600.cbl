      ...
      *                      *-----------------------------------------*
           if        d-qev-rof-qta-dri    =    zero
                     go to exe-pgm-ric-180.
      *                  *---------------------------------------------*
      *                  * Selezione su data consegna confermata       *
      *                  *---------------------------------------------*
           if        rf-ofr-dcn-cnf       >    w-gen-dat-att
                     go to exe-pgm-ric-180.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       exe-pgm-ric-200.
      *              *-------------------------------------------------*
      *              * Aggiornamento data consegna confermata          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Incremento di 10 giorni della data consegna *
      *                  * confermata del fornitore                    *
      *                  *---------------------------------------------*
           move      w-gen-dat-att        to   w-det-dat-nrg-dtb      .
           move      10                   to   w-det-dat-nrg-ngi      .
           perform   det-dat-nrg-000      thru det-dat-nrg-999        .
           move      w-det-dat-nrg-dti    to   rf-ofr-dcn-cnf         .
      *                  *---------------------------------------------*
      *                  * Aggiornamento flag di conferma              *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se flag precedentemente a spazi         *
      *                      *-----------------------------------------*
           if        rf-ofr-flg-cnf       not  = spaces
                     go to exe-pgm-ric-220.
      *                      *-----------------------------------------*
      *                      * Come per 'F' ma manca conferma          *
      *                      *-----------------------------------------*
           move      "?"                  to   rf-ofr-flg-cnf         .
      *                      *-----------------------------------------*
      *                      * A update                                *
      *                      *-----------------------------------------*
           go to     exe-pgm-ric-240.
       exe-pgm-ric-220.
      *                      *-----------------------------------------*
      *                      * Se flag precedentemente non a spazi     *
      *                      *-----------------------------------------*
           if        rf-ofr-flg-cnf       =    "S"
      ...
      *                      * Istruzioni obsolete                     *
      *                      *-----------------------------------------*
______*    else if   rf-ofr-flg-cnf       =    "Z"
______*              move  "Z"            to   rf-ofr-flg-cnf
______*    else      move  "F"            to   rf-ofr-flg-cnf         .
       exe-pgm-ric-240.
      *                  *---------------------------------------------*
      *                  * Update record [ofr]                         *
      *                  *---------------------------------------------*
