      ...
      *            * Data massima                                      *
      *            *---------------------------------------------------*
               10  srt-dat-max            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Flag di invio                                     *
      *            *---------------------------------------------------*
               10  srt-flg-inv            pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    INTERROGAZIONE SU FILE POS EMESSI   "       .
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Start su archivio [hpo]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATPTH    "         to   f-key                  .
      ...
      *                  * Composizione                                *
      *                  *---------------------------------------------*
           move      rf-hpo-dat-min       to   srt-dat-min            .
           move      rf-hpo-pth-pos       to   srt-pth-pos            .
           move      rf-hpo-dat-max       to   srt-dat-max            .
           move      rf-hpo-flg-inv       to   srt-flg-inv            .
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       qry-nes-ela-000.
           move      "ME"                 to   v-ope                  .
           move      "Nessun file POS entro i limiti assegnati !"
                                          to   v-not                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-nes-ela-999.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-qry-flg-int      .
      *              *-------------------------------------------------*
      *              * Lettura record [hpo] per record di coda         *
      *              *-------------------------------------------------*
           move      "RK"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      23                   to   v-pos                  .
           move      srt-dat-min          to   v-dat                  .
           move      "+"                  to   v-edm                  .
           move      srt-pth-pos          to   w-mpn-pth-pos          .
           move      w-mpn                to   v-cnt                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      48                   to   v-pos                  .
      *
           if        srt-flg-inv          =    spaces
                     move  "File generato"
                                          to   v-alf
           else      move  "File inviato" to   v-alf                  .
      *
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
       qry-liv-det-900.
      ...
      *              *-------------------------------------------------*
           ...
           move      v-lnr                to   v-lin                  .
           move      21                   to   v-pos                  .
           move      "    INTERROGAZIONE SU FILE POS EMESSI   "
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
