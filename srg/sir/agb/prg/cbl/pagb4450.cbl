      ...
      *                       Ultima revisione:    NdK del 10/11/08    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Estrazione statistiche ordinato per MOLEX   *
      *                                                                *
      *                    /abd/asc/exp/MOLEX.TXT                      *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " ESTRAZIONE STATISTICHE ORDINATO MOLEX  "       .
      ...
      *        * Distributore                                          *
      *        *-------------------------------------------------------*
           05  w-orc-rag-azi              pic  x(20)                  .
      *        *-------------------------------------------------------*
      *        * Ragione sociale cliente                               *
      *        *-------------------------------------------------------*
           05  w-orc-rag-cli              pic  x(30)                  .
      *        *-------------------------------------------------------*
      *        * Partita IVA                                           *
      *        *-------------------------------------------------------*
           05  w-orc-prt-iva              pic  x(11)                  .
      *        *-------------------------------------------------------*
      *        * Numero documento                                      *
      *        *-------------------------------------------------------*
           05  w-orc-num-doc              pic  x(06)                  .
      *        *-------------------------------------------------------*
      *        * Codice del prodotto per la casa produttrice           *
      *        *-------------------------------------------------------*
           05  w-orc-cdp-pdt              pic  x(20)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' (12 interi)                                 *
      *        *-------------------------------------------------------*
           05  w-orc-qta-ven              pic  x(12)                  .
      *        *-------------------------------------------------------*
      *        * Valore (10 interi, 2 decimali)                        *
      *        *-------------------------------------------------------*
           05  w-orc-tot-val              pic  x(12)                  .
      *        *-------------------------------------------------------*
      *        * Data (GGMMAA)                                         *
      *        *-------------------------------------------------------*
           05  w-orc-dat-doc.
               10  w-orc-gio-doc          pic  x(02)                  .
               10  w-orc-mes-doc          pic  x(02)                  .
               10  w-orc-ann-doc          pic  x(02)                  .
      *        *-------------------------------------------------------*
      *        * Carattere per CR + LF                                 *
      *        *-------------------------------------------------------*
           05  w-orc-chr-end              pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-dat-min           to   rf-ocr-dat-doc         .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-oct                 .
      *                  *---------------------------------------------*
      *                  * Esclusione Forecast (NO - Sonia 10/11/08)   *
      *                  *---------------------------------------------*
______*    if        rf-oct-tip-ord       not  = spaces
______*              go to crz-arc-ven-100.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "CODCLI    "         to   f-key                  .
           move      rf-ocr-cod-arc       to   rf-cli-cod-cli         .
           move      "pgm/cge/fls/ioc/obj/iofcli"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Distributore                                *
      *                  *---------------------------------------------*
           move      "SIRI Spa"           to   w-orc-rag-azi          .
      *                  *---------------------------------------------*
      *                  * Ragione sociale cliente                     *
      *                  *---------------------------------------------*
           move      rf-dcc-rag-soc       to   w-orc-rag-cli          .
      *                  *---------------------------------------------*
      *                  * Partita IVA                                 *
      *                  *---------------------------------------------*
           move      "ED"                 to   v-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-orc-num-doc          .
      *                  *---------------------------------------------*
      *                  * Codice del prodotto per la casa produttrice *
      *                  *---------------------------------------------*
           move      rf-aaq-cdp-pdt       to   w-orc-cdp-pdt          .
       crz-arc-ven-660.
      *                  *---------------------------------------------*
      *                  * Quantita' di vendita                        *
      *                  *---------------------------------------------*
      ...
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      v-edt                to   w-orc-qta-ven          .
      *                      *-----------------------------------------*
      *                      * Allineamento a destra                   *
      *                      *-----------------------------------------*
           move      12                   to   w-all-str-lun          .
           move      w-orc-qta-ven        to   w-all-str-alf          .
           perform   all-str-adx-000      thru all-str-adx-999        .
           move      w-all-str-alf        to   w-orc-qta-ven          .
      *                      *-----------------------------------------*
      *                      * Riempimento con zeri                    *
      *                      *-----------------------------------------*
           inspect   w-orc-qta-ven
                                replacing all  " "
                                          by   "0"                    .
       crz-arc-ven-680.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-ocr-imp-rig       to   w-det-imp-vlb-imp      .
      *                      *-----------------------------------------*
      *                      * Test se necessario                      *
      *                      *-----------------------------------------*
           if        rf-ocr-sgl-vpf       =    c-sgl
                     go to crz-arc-ven-700.
      *                      *-----------------------------------------*
      ...
      *                      * Bufferizzazione                         *
      *                      *-----------------------------------------*
           move      v-edt                to   w-orc-tot-val          .
      *                      *-----------------------------------------*
      *                      * Allineamento a destra                   *
      *                      *-----------------------------------------*
           move      12                   to   w-all-str-lun          .
           move      w-orc-tot-val        to   w-all-str-alf          .
           perform   all-str-adx-000      thru all-str-adx-999        .
           move      w-all-str-alf        to   w-orc-tot-val          .
      *                      *-----------------------------------------*
      *                      * Riempimento con zeri                    *
      *                      *-----------------------------------------*
           inspect   w-orc-tot-val
                                replacing all  " "
                                          by   "0"                    .
       crz-arc-ven-680.
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-gen-chr-end        to   w-orc-chr-end          .
       crz-arc-ven-800.
      *              *-------------------------------------------------*
