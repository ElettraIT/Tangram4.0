      ...
      *                       Ultima revisione:    NdK del 10/12/20    *
      *                    ------------------------------------------- *
      ...
      *                      *-----------------------------------------*
           ...
           move      rf-hpo-cod-cli       to   rf-dcc-cod-cli         .
           move      rf-hpo-dpz-cli       to   rf-dcc-dpz-cli         .
           move      "pgm/dcc/fls/ioc/obj/iofdcc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                          *-------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      061                  to   p-pos                  .
           move      rf-hpo-cos-uni       to   p-num                  .
           divide    10000000             into p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Tipo documento                          *
      ...
      *              *-------------------------------------------------*
           ...
           move      "FILE POS PER VISHAY -"
                                          to   w-all-str-cat (1)      .
           move      rr-fil-pos           to   w-all-str-cat (2)      .
