      ...
      *                       Ultima revisione:    NdK del 21/05/19    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Estrazione statistiche per VISHAY da DDT    *
      *                                                                *
      *                    ------------------------------------------- *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
      *        * Prezzo netto prodotto di comodo                       *
      *        *-------------------------------------------------------*
           05  w-gen-prz-net              pic  9(11)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-dat-min           to   rf-bir-dat-doc         .
      ...
      *                      *-----------------------------------------*
      *                      * Prezzo netto in campo di comodo         *
      *                      *-----------------------------------------*
           move      rf-bir-prz-net       to   w-gen-prz-net          .
      *                      *-----------------------------------------*
      *                      * Correttivo per decimali prezzo          *
      *                      *-----------------------------------------*
           if        rf-bir-dec-prz       =    0
                     multiply 100         by   w-gen-prz-net          .
      *                      *-----------------------------------------*
      *                      * Interi                                  *
      *                      *-----------------------------------------*
           move      "0000"               to   w-vsy-dtl-upi
                                              (01 : 04)               .
           move      w-gen-prz-net
                    (01 : 04)             to   w-vsy-dtl-upi
                                              (05 : 04)               .
      *                      *-----------------------------------------*
      *                      * Virgola                                 *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      rf-bir-cop-scl       to   w-vsy-dtl-cpn          .
       crz-arc-ven-780.
      *                  *---------------------------------------------*
      *                  * Composizione carattere di fine record       *
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-bir-imp-rig       to   w-det-imp-vlb-imp      .
      *                      *-----------------------------------------*
      *                      * Test se necessario                      *
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           add       w-det-imp-vlb-imp    to   w-gen-tot-gen          .
       crz-arc-ven-840.
      *              *-------------------------------------------------*
