      ...
      *                       Ultima revisione:    NdK del 04/08/11    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Invio file '.csv' a MOLEX - SIRI            *
      *                                                                *
      *                   (Presume che il file sia preparato           *
      *                    da 'agb440' e manipolato da Sonia)          *
      *                                                                *
      *                    Uso del modulo : t_sir_xls_csv              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "    INVIO FILE 'CSV' A MOLEX VIA FTP    "       .
      ...
      *        *-------------------------------------------------------*
      *        * Comodo per tipo esecuzione                            *
      *        *-------------------------------------------------------*
           05  w-gen-tip-exe              pic  x(01)                  .
      ...
      *                  *---------------------------------------------*
           if        rr-tip-exe           =    01
                     move  "I"            to   w-gen-tip-exe
           else      move  "C"            to   w-gen-tip-exe          .
      *                  *---------------------------------------------*
      *                  * Comando di invio                            *
      *                  *---------------------------------------------*
           move      spaces               to   o-shs                  .
           string    "t_sir_xls_csv "
                                delimited by   size
                     w-det-pth-fso-pt2
                                delimited by   spaces
                     " "
      ...
      *                  *---------------------------------------------*
           move      ".xls"               to   w-det-pth-fso-sfx      .
      *                  *---------------------------------------------*
      *                  * Preparazione nome file completo             *
      *                  *---------------------------------------------*
           move      spaces               to   w-det-pth-fso-pt2      .
           string    w-det-pth-fso-pt1
                                delimited by   spaces
                     w-det-pth-fso-sfx
                                delimited by   size
