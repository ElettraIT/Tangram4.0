      ...
      *                                   Fase:    agb900              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 17/02/10    *
      *                       Ultima revisione:    NdK del 17/02/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma agb900   *
      *                                                                *
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   CANCELLAZIONE SCHEDE CLIENTI > 9000  "       .
      ...
      *              *-------------------------------------------------*
           ...
           move      0009000              to   rf-cli-cod-cli         .
           move      "pgm/cge/fls/ioc/obj/iofcli"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
      *                  * Composizione chiave record di sort          *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
      *                  * Composizione dati record di sort            *
      *                  *---------------------------------------------*
       stp-srt-inp-700.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-cli                 .
      *                  *---------------------------------------------*
      *                  * Emissione messaggio di cancellazione clien- *
      *                  * te effettuata                               *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      "- CANCELLATO"       to   w-all-str-cat (5)      .
