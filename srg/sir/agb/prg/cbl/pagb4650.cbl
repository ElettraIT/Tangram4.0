      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pagb4651:        *
      *                                                                *
      *                    Situazione giacenze di proprieta'           *
      *                    valorizzate prodotti di vendita             *
      *                                                                *
      *                    MAG460 SU MISURA PER SIRI                   *
      *                                                                *
      *================================================================*
      ...
      *                  * Percentuale                                 *
      *                  *---------------------------------------------*
           perform   acc-per-clr-000      thru acc-per-clr-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *                  * Percentuale                                 *
      *                  *---------------------------------------------*
           move      30                   to   rr-per-clr             .
           perform   vis-per-clr-000      thru vis-per-clr-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Accettazione campo selezione : Percentuale                *
      *    *-----------------------------------------------------------*
       acc-per-clr-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-per-clr-999.
       acc-per-clr-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-per-clr             .
       acc-per-clr-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *                  * sia in Up                                   *
      *                  *---------------------------------------------*
           if        rr-per-clr           not  = zero
                     go to acc-per-clr-600.
           if        v-key                =    "UP  "
                     go to acc-per-clr-600
           else      go to acc-per-clr-100.
       acc-per-clr-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "DO  "
                     ...
                     if      w-cnt-tdo-ric-flg
                             ...
                             go to acc-per-clr-100.
       acc-per-clr-999.
           exit.

      *    *===========================================================*
      *    * Visualizzaz. campo selezione : Percentuale                *
      *    *-----------------------------------------------------------*
       vis-per-clr-000.
           move      "DS"                 to   v-ope                  .
           move      "N"                  to   v-tip                  .
