      ...
      *            *---------------------------------------------------*
      *            * Codice ns. prodotto numerico                      *
      *            *---------------------------------------------------*
               10  srt-num-pro            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Codice ns. prodotto alfanumerico                  *
      *            *---------------------------------------------------*
               10  srt-alf-pro            pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Quantita' per il prezzo                           *
      *            *---------------------------------------------------*
               10  srt-qta-prz            pic  9(07)                  .
      *            *---------------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           ...
           05  w-rig-qta-prz              pic  9(07)                  .
           05  w-rig-prz-lst              pic  9(09)                  .
           05  w-rig-dat-agg              pic  9(07)                  .
           05  w-rig-alx-exp.
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Work per codice min - max                             *
      *        *-------------------------------------------------------*
           05  w-det-cod-alf.
               10  w-det-cod-alf-min      pic  x(20)                  .
               05  w-det-cod-alf-max.
                   10  w-det-cod-alf-mxx
                               occurs 20  pic  x(01)                  .
               10  w-det-cod-alf-ctr      pic  9(03)                  .
      ...
      *                  *---------------------------------------------*
           perform   acc-key-alf-000      thru acc-key-alf-999        .
      ...
      *                  * Accettazione codice alfanumerico            *
      *                  *---------------------------------------------*
           perform   pmt-key-alf-000      thru pmt-key-alf-999        .
       pmt-key-reg-999.
           exit.
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-tus-acc-key
                     go to acc-key-alf-999.
       acc-key-alf-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-alf                to   w-tes-cod-alf          .
       acc-key-alf-400.
      *              *-------------------------------------------------*
      ...
      *                      * Per codice prodotto                     *
      *                      *-----------------------------------------*
           perform   vis-key-alf-000      thru vis-key-alf-999        .
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           perform   acc-cod-alf-000      thru acc-cod-alf-999        .
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-alf        to   w-lin-imm-alf-pro      .
       vis-lin-cor-460.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-sgl-vlt        to   w-all-str-cat (1)      .
      *
           if        w-rig-qta-prz        =    zero
                     move  spaces         to   w-all-str-cat (2)
                     move  spaces         to   w-all-str-cat (3)
           else      move  "x"            to   w-all-str-cat (2)
                     move  v-edt          to   w-all-str-cat (3)      .
      *
           perform   all-str-csb-000      thru all-str-csb-999        .
      *
           move      ":"                  to   w-all-str-alf (19 : 1) .
      *              *-------------------------------------------------*
      *              * Visualizzazione                                 *
      *              *-------------------------------------------------*
           move      "DS"                 to   v-ope                  .
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Ns. codice prodotto              *
      *    *-----------------------------------------------------------*
       pmt-alf-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *                  *---------------------------------------------*
           move      w-rig-cod-alf        to   w-sav-cod-alf          .
       acc-cod-alf-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-sav-cod-alf        to   w-rig-cod-alf          .
       acc-cod-alf-120.
      *                  *---------------------------------------------*
      *                  * Parametri generici                          *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     ...
                     go to acc-cod-alf-999.
       acc-cod-alf-225.
      *              *-------------------------------------------------*
      *              * Test se Return                                  *
      *              *-------------------------------------------------*
           if        v-key                =    spaces
                     go to acc-cod-alf-400.
       acc-cod-alf-250.
      *              *-------------------------------------------------*
      *              * Se Slct                                         *
      *              *-------------------------------------------------*
           if        v-key                not  = "SLCT"
                     go to acc-cod-alf-300.
       acc-cod-alf-255.
      *                  *---------------------------------------------*
      ...
      *    *===========================================================*
      *    * Visualizzazione : Ns. Codice prodotto alfanumerico        *
      *    *-----------------------------------------------------------*
       vis-alf-pro-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *-----------------------------------------------------------*
       stp-srt-inp-000.
      *              *-------------------------------------------------*
      *              * Preparazione codice min - max                   *
      *              *-------------------------------------------------*
           move      w-tes-cod-alf        to   w-det-cod-alf-min      .
           move      w-tes-cod-alf        to   w-det-cod-alf-max      .
      *              *-------------------------------------------------*
      *              * Padding                                         *
      *              *-------------------------------------------------*
           move      20                   to   w-det-cod-alf-ctr      .
       stp-srt-inp-020.
           if        w-det-cod-alf-ctr    >    zero
                     if    w-det-cod-alf-mxx
                          (w-det-cod-alf-ctr)
                                          =    spaces
                           move     "z"   to   w-det-cod-alf-mxx
                                              (w-det-cod-alf-ctr)
                           subtract 1     from w-det-cod-alf-ctr
                           go to stp-srt-inp-020.
       stp-srt-inp-100.
      *              *-------------------------------------------------*
      *              * Start su archivio [hlf]                         *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "CODALF    "         to   f-key                  .
           move      w-det-cod-alf-min    to   rf-hlf-cod-alf         .
      ...
      *                  *---------------------------------------------*
           if        rf-hlf-cod-alf       >    w-det-cod-alf-max
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-hlf-num-pro       to   rf-dcp-num-pro         .
           move      "pgm/dcp/fls/ioc/obj/iofdcp"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                      * Codice prodotto                         *
      *                      *-----------------------------------------*
           move      rf-hlf-cod-alf       to   srt-cod-alf            .
      *                      *-----------------------------------------*
      *                      * Descrizione in chiave                   *
      *                      *-----------------------------------------*
           move      rf-hlf-des-key       to   srt-des-key            .
      *                  *---------------------------------------------*
      *                  * Preparazione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           move      rf-hlf-des-alf       to   srt-des-pro            .
      *                      *-----------------------------------------*
      *                      * Sigla valuta                            *
      *                      *-----------------------------------------*
           move      rf-hlf-sgl-vlt       to   srt-sgl-vlt            .
      *                      *-----------------------------------------*
      *                      * Numero decimali valuta                  *
      *                      *-----------------------------------------*
           move      rf-hlf-dec-vlt       to   srt-dec-vlt            .
      *                      *-----------------------------------------*
      *                      * Numero decimali prezzo                  *
      *                      *-----------------------------------------*
           move      rf-hlf-dec-prz       to   srt-dec-prz            .
      *                      *-----------------------------------------*
      *                      * Codice ns. prodotto numerico            *
      *                      *-----------------------------------------*
           move      rf-hlf-num-pro       to   srt-num-pro            .
      *                      *-----------------------------------------*
      *                      * Codice ns. prodotto alfanumerico        *
      *                      *-----------------------------------------*
      ...
      *                      * Quantita' per il prezzo                 *
      *                      *-----------------------------------------*
           move      rf-hlf-qta-prz       to   srt-qta-prz            .
      *                      *-----------------------------------------*
      *                      * Prezzo di listino                       *
      *                      *-----------------------------------------*
           move      rf-hlf-prz-lst       to   srt-prz-lst            .
      *                      *-----------------------------------------*
      *                      * Data aggiornamento                      *
      *                      *-----------------------------------------*
           move      rf-hlf-dat-agg       to   srt-dat-agg            .
      *                  *---------------------------------------------*
      ...
      *                      * Codice prodotto                         *
      *                      *-----------------------------------------*
           move      srt-cod-alf          to   w-rig-cod-alf          .
      *                      *-----------------------------------------*
      ...
      *                      * Quantita' per il prezzo                 *
      *                      *-----------------------------------------*
           move      srt-qta-prz          to   w-rig-qta-prz          .
      *                      *-----------------------------------------*
      *                      * Prezzo d'acquisto attuale               *
      *                      *-----------------------------------------*
      ...
      *                      * Data aggiornamento                      *
      *                      *-----------------------------------------*
           move      srt-dat-agg          to   w-rig-dat-agg          .
       car-fil-rap-460.
      *                  *---------------------------------------------*
      *                  * Continuazione                               *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "sir/agb/prg/obj/pagb8202"                       .
       cnc-rlt-sup-999.
           exit.
