      ...
      *                       Ultima revisione:    NdK del 18/06/24    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
           05  w-exp-val-agg.
               10  w-exp-val-agg-num      pic  9(02)       value 02   .
      ...
      *              *-------------------------------------------------*
      *              * Start su archivio [oft] per codice archivio     *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
      ...
      *              * ciale del fornitore per tutto il ciclo          *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Normalizzazione [fnt]                       *
      *                  *---------------------------------------------*
      ...
      *                      * di pagamento                            *
      *                      *-----------------------------------------*
           move      rf-yfp-sco-fat       to   rf-oft-scp-aap         .
       prn-liv-det-400.
      *                  *---------------------------------------------*
      *                  * Appoggi bancari                             *
      *                  *---------------------------------------------*
      ...
      *    *                                                           *
      *    * ATTUALMENTE NON IMPLEMENTATO (vedi 'agb120')              *
      *    *-----------------------------------------------------------*
       prn-liv-det-rig-000.
      *              *-------------------------------------------------*
