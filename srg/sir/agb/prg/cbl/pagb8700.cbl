      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Abbinamento spunte carico con lista         *
      *                                                                *
      *                    SU MISURA PER SIRI                          *
      *                                                                *
      *                    N.B.: nessun controllo su codici prodotto e *
      *                          su quantita' tra [bfo] e [ods]        *
      *                                                                *
      *                    ___ SOSTITUITO DA 'sirbfoB1' ___            *
      *                                                                *
      ...
      *              *-------------------------------------------------*
       ...
       tdo-ric-sel-100.
      *              *-------------------------------------------------*
      *              * Test su protocollo [bfo]                        *
      *              *-------------------------------------------------*
           if        rr-prt-bfo           not  = zero
                     go to tdo-ric-sel-200.
           move      "Manca il protocollo [bfo] !"
      ...
      *              * Regolarizzazione numero ordine                  *
      *              *-------------------------------------------------*
           move      rr-prt-ods           to   w-wrk-nos-acc          .
      *
           if        w-wrk-num-npg        =    zero
                     move  zero           to   rr-prt-ods
      ...
      *
           ...
           move      01                   to   w-wrk-noc-dpz          .
           move      w-wrk-num-npg        to   w-wrk-noc-npg          .
           move      w-wrk-nos-int        to   rr-prt-ods             .
       reg-ric-sel-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Scrittura record [hbc]                          *
      *              *-------------------------------------------------*
           perform   wrt-rec-hbc-000      thru wrt-rec-hbc-999        .
      *              *-------------------------------------------------*
      *              * Scrittura record [hbc] immagini o documenti     *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
           move      s-dat                to   rf-hbc-ide-dat         .
           move      s-ute                to   rf-hbc-ide-ute         .
           move      s-fas                to   rf-hbc-ide-fas         .
      *              *-------------------------------------------------*
      *              * Nuovo protocollo                                *
      *              *-------------------------------------------------*
           move      rr-prt-ods           to   rf-hbc-num-prt         .
      *              *-------------------------------------------------*
      *              * Put record                                      *
      *              *-------------------------------------------------*
           move      "PT"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      "Spunta abbinata con successo !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       wrt-rec-hbc-999.
      ...
      *    *===========================================================*
      *    * Scrittura record [hbc] per immagini o documenti           *
      *    *-----------------------------------------------------------*
       wrt-rec-ida-000.
      *              *-------------------------------------------------*
      *              * Test su tipo record                             *
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      "Elemento abbinato con successo !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       wrt-rec-ida-999.
