      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Manutenzione date righe ordini clienti      *
      *                                                                *
      *                    SIRI                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     " MANUTENZIONE DATE RIGHE ORDINI CLIENTI "       .
      ...
      *    *-----------------------------------------------------------*
       01  w-cmp-rec.
      *        *-------------------------------------------------------*
      *        * Work per composizione record [ocr]                    *
      *        *-------------------------------------------------------*
           05  w-cmp-rec-ocr.
      *            *---------------------------------------------------*
      *            * Protocollo                                        *
      *            *---------------------------------------------------*
               10  w-cmp-rec-ocr-prt      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Progressivo                                       *
      *            *---------------------------------------------------*
               10  w-cmp-rec-ocr-prg      pic  9(05)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-det-sel-ocr.
               10  w-det-sel-ocr-inc      pic  9(11)                  .
               10  w-det-sel-ocr-sdo      pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           ...
           perform   fnd-arc-ocr-000      thru fnd-arc-ocr-999        .
      ...
      *                  * Codice prodotto                             *
      *                  *---------------------------------------------*
           move      rf-ocr-alf-pro       to   w-lin-imm-alf-mag      .
       vis-lin-cor-490.
      *                  *---------------------------------------------*
      *                  * Editing quantita'                           *
      *                  *---------------------------------------------*
      ...
      *                  * Flag conferma                               *
      *                  *---------------------------------------------*
           move      rf-ocr-flg-cnf       to   w-lin-imm-flg-cnf      .
       vis-lin-cor-500.
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      04                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      " N.R.     Cliente       Prodotto            Quanti
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-ocr-tmo-orc       to   w-all-str-cat (1)      .
      ...
      *              *-------------------------------------------------*
           ...
           move      w-tes-dat-min        to   rf-oct-dat-doc         .
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-ocr-dat-doc       >    w-tes-dat-min
      ...
      *                  *---------------------------------------------*
           if        rf-ocr-dat-doc       >    w-tes-dat-max
                     go to stp-srt-inp-900.
           go to     stp-srt-inp-400.
       stp-srt-inp-400.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rf-oct-cod-arc       not  = w-tes-cod-arc
                     go to stp-srt-inp-200.
       stp-srt-inp-460.
      *                  *---------------------------------------------*
      ...
      *                  * Record [ocr]                                *
      *                  *---------------------------------------------*
           move      rf-ocr               to   w-rig-rec-ocr          .
           move      rf-ocr-cod-arc       to   w-rig-cod-arc          .
           move      rf-ocr-dpz-arc       to   w-rig-dpz-arc          .
           move      rf-ocr-dcn-cnf       to   w-rig-dcn-cnf          .
      *                  *---------------------------------------------*
      *                  * Valori indiretti                            *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Anagrafica archivio                     *
      *                      *-----------------------------------------*
           move      w-rig-cod-arc        to   w-let-arc-dcc-cli      .
           move      w-rig-dpz-arc        to   w-let-arc-dcc-dpz      .
           perform   let-arc-dcc-000      thru let-arc-dcc-999        .
           move      w-let-arc-dcc-rag    to   w-rig-cod-arc-rag      .
       car-fil-rap-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-rig-rec-ocr        to   rf-ocr                 .
           move      rf-ocr-num-prt       to   w-cmp-rec-ocr-prt      .
           move      rf-ocr-num-prg       to   w-cmp-rec-ocr-prg      .
       sca-fil-rap-500.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      "GK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-cmp-rec-ocr-prt    to   rf-ocr-num-prt         .
           move      w-cmp-rec-ocr-prg    to   rf-ocr-num-prg         .
           move      "pgm/orc/fls/ioc/obj/iofocr"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  *---------------------------------------------*
           move      w-rig-dcn-cnf        to   rf-ocr-dcn-cnf         .
       sca-fil-rap-700.
      *                  *---------------------------------------------*
      *                  * Update record [ocr]                         *
      *                  *---------------------------------------------*
      ...
      *    *-----------------------------------------------------------*
       cnc-rlt-sup-000.
           cancel    "sir/agb/prg/obj/pagb9402"                       .
       cnc-rlt-sup-999.
           exit.
