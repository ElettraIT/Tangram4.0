      ...
      *                       Ultima revisione:    NdK del 03/09/05    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    /abd/asc/{utente}/pdf/out/mag410.txt        *
      *                                                                *
      *                    (delimitato da TAB)                         *
      *                                                                *
      *                    solo Guido e Giorgio                        *
      *                                                                *
      *                    SU MISURA PER AZIENDA SIRI (Stampa diversa) *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-det.
      *        *-------------------------------------------------------*
      *        * Determinazione date ultima movimentazione             *
      *        *-------------------------------------------------------*
           05  w-det-dat-ult.
      *            *---------------------------------------------------*
      *            * Tipo magazzino                                    *
      *            *---------------------------------------------------*
               10  w-det-dat-ult-tip      pic  9(02)                  .
      *            *---------------------------------------------------*
      *            * Codice magazzino                                  *
      *            *---------------------------------------------------*
               10  w-det-dat-ult-num      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Data ultimo carico                                *
      *            *---------------------------------------------------*
               10  w-det-dat-ult-car      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Data ultimo scarico                               *
      *            *---------------------------------------------------*
               10  w-det-dat-ult-sca      pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Per Fine riga                                         *
      *        *-------------------------------------------------------*
           05  w-det-fin-rig.
      ...
      *            * Codice prodotto                                   *
      *            *---------------------------------------------------*
               10  w-out-gcz-cod-mag      pic  x(14)                  .
               10  w-out-gcz-sep-001      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Codice prodotto per il fornitore                  *
      *            *---------------------------------------------------*
               10  w-out-gcz-cop-sfn      pic  x(20)                  .
               10  w-out-gcz-sep-002      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Descrizione prodotto                              *
      *            *---------------------------------------------------*
               10  w-out-gcz-des-mag      pic  x(40)                  .
               10  w-out-gcz-sep-003      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Quantita' in giacenza                             *
      *            *---------------------------------------------------*
               10  w-out-gcz-qta-gcz      pic  x(15)                  .
               10  w-out-gcz-sep-004      pic  x(01)                  .
      *            *---------------------------------------------------*
      *            * Carattere di fine riga                            *
      *            *---------------------------------------------------*
               10  w-out-gcz-fin-rig      pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
       ...
       prn-liv-det-010.
      *              *-------------------------------------------------*
      *              * Raccolta dati relativi al prodotto              *
      *              *-------------------------------------------------*
       prn-liv-det-020.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
       ...
       prn-liv-det-030.
      *                  *---------------------------------------------*
      *                  * Date ultima movimentazione                  *
      *                  *---------------------------------------------*
           move      01                   to   w-det-dat-ult-tip      .
           move      rf-dcp-num-pro       to   w-det-dat-ult-num      .
           perform   det-dat-ult-000      thru det-dat-ult-999        .
       prn-liv-det-050.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      065                  to   p-pos                  .
           move      w-det-dat-ult-car    to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Data ultimo scarico                         *
      *                  *---------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      075                  to   p-pos                  .
           move      w-det-dat-ult-sca    to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      s-pat               using f
                                               rf-aaq                 .
      *                      *-----------------------------------------*
      *                      * Stampa codice prodotto per produttore   *
      *                      *-----------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "A"                  to   p-tip                  .
           move      20                   to   p-car                  .
      ...
      *                          *-------------------------------------*
           move      w-det-fin-rig-tab    to   w-out-gcz-sep-001
                                               w-out-gcz-sep-002
                                               w-out-gcz-sep-003
                                               w-out-gcz-sep-004      .
      *                          *-------------------------------------*
      *                          * Codice prodotto                     *
      *                          *-------------------------------------*
           move      rf-dcp-alf-pro       to   w-out-gcz-cod-mag      .
      *                          *-------------------------------------*
      *                          * Codice prodotto per il fornitore    *
      *                          *-------------------------------------*
           move      rf-aaq-cdp-pdt       to   w-out-gcz-cop-sfn      .
      *                          *-------------------------------------*
      *                          * Descrizione prodotto                *
      *                          *-------------------------------------*
           move      rf-dcp-des-pro       to   w-out-gcz-des-mag      .
      *                          *-------------------------------------*
      *                          * Quantita' in giacenza               *
      *                          *-------------------------------------*
           move      "ED"                 to   p-ope                  .
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-edt                to   w-out-gcz-qta-gcz      .
      *                          *-------------------------------------*
      *                          * Carattere di fine riga              *
      *                          *-------------------------------------*
           move      w-det-fin-rig-chr    to   w-out-gcz-fin-rig      .
      *                      *-----------------------------------------*
      *                      * Scrittura record in output              *
      *                      *-----------------------------------------*
           move      w-out-gcz            to   g-rec                  .
      ...
      *              *-------------------------------------------------*
      ...
      -              "        C.M.  Ult.Car.  Ult.Sca.    Giacenza    Co
      -              "dice x produttore               "
                                          to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      ...
      *    *===========================================================*
      *    * Determinazione ultima movimentazione prodotti             *
      *    *-----------------------------------------------------------*
       det-dat-ult-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione date in uscita                  *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-dat-ult-car      .
           move      zero                 to   w-det-dat-ult-sca      .
       det-dat-ult-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      "NG"                 to   f-cfr                  .
           move      w-det-dat-ult-tip    to   rf-mmr-tip-mag         .
           move      w-det-dat-ult-num    to   rf-mmr-num-mag         .
           move      9999999              to   rf-mmr-dat-reg         .
      ...
      *              * Test max                                        *
      *              *-------------------------------------------------*
           if        rf-mmr-tip-mag       not  = w-det-dat-ult-tip or
                     rf-mmr-num-mag       not  = w-det-dat-ult-num
                     go to det-dat-ult-900.
       det-dat-ult-400.
      *              *-------------------------------------------------*
      *              * Test sul tipo movimento                         *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Deviazione in funzione del tipo movimento   *
      *                  *---------------------------------------------*
           if        rf-mmr-tip-mdm       =    01
                     go to det-dat-ult-500
           else if   rf-mmr-tip-mdm       =    02
                     go to det-dat-ult-600
           else      go to det-dat-ult-200.
       det-dat-ult-500.
      *                  *---------------------------------------------*
      *                  * Se carico                                   *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Test se data gia' bufferizzata          *
      *                      *-----------------------------------------*
           if        w-det-dat-ult-car    not  = zero
                     go to det-dat-ult-800.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione data ultimo carico      *
      *                      *-----------------------------------------*
           move      rf-mmr-dat-reg       to   w-det-dat-ult-car      .
      *                      *-----------------------------------------*
      *                      * A test se necessario riciclo            *
      *                      *-----------------------------------------*
           go to     det-dat-ult-800.
       det-dat-ult-600.
      *                  *---------------------------------------------*
      ...
      *                      * Test se data gia' bufferizzata          *
      *                      *-----------------------------------------*
           if        w-det-dat-ult-sca    not  = zero
                     go to det-dat-ult-800.
      *                      *-----------------------------------------*
      *                      * Bufferizzazione data ultimo scarico     *
      *                      *-----------------------------------------*
           move      rf-mmr-dat-reg       to   w-det-dat-ult-sca      .
      *                      *-----------------------------------------*
      *                      * A test se necessario riciclo            *
      *                      *-----------------------------------------*
           go to     det-dat-ult-800.
      ...
      *              *-------------------------------------------------*
           if        w-det-dat-ult-car    not  = zero and
                     w-det-dat-ult-sca    not  = zero
                     go to det-dat-ult-900
           else      go to det-dat-ult-200.
       det-dat-ult-900.
      *              *-------------------------------------------------*
