      ...
      *                       Ultima revisione:    NdK del 21/10/10    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Esecuzione stampa per il programma fab435   *
      *                                                                *
      *                    Determinazione scorta minima prodotti di    *
      *                    vendita da ordini clienti                   *
      *                                                                *
      *                    SU MISURA PER SIRI (forecast e quantita')   *
      *                                                                *
      *================================================================*
      ...
      *    *-----------------------------------------------------------*
       01  w-ref.
      *        *-------------------------------------------------------*
      *        * Referenze relative al programma fab435                *
      *        *-------------------------------------------------------*
           05  w-ref-fab-430.
      ...
      *    *===========================================================*
      *    * Work-area per routine det-qta-ord-000/999                 *
      *    *-----------------------------------------------------------*
       01  w-det-qta-ord.
      *        *-------------------------------------------------------*
      *        * Tipo codice di magazzino                      [Input] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-tpm          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Codice numerico di magazzino                  [Input] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-cnm          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Data riferimento iniziale                     [Input] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-dti          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Data riferimento finale                       [Input] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-dtf          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Mese da escludere                             [Input] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-mde          pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Comodo per ridefinizione data                  [Work] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-wdt          pic  9(07)                  .
           05  w-det-qta-ord-wdt-r redefines
               w-det-qta-ord-wdt.
               10  w-det-qta-ord-wsa      pic  9(03)                  .
               10  w-det-qta-ord-wme      pic  9(02)                  .
               10  w-det-qta-ord-wgi      pic  9(02)                  .
      *        *-------------------------------------------------------*
      *        * Tabella clienti movimentati                    [Work] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-tbl.
               10  w-det-qta-ord-ele      pic  9(05)                  .
               10  w-det-qta-ord-max      pic  9(05) value 3000       .
               10  w-det-qta-ord-sng occurs 3000.
                   15  w-det-qta-ord-cli  pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Contatore di comodo 1                          [Work] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-c01          pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Quantita' fatturata nel periodo              [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-qfp          pic s9(08)v9(03)            .
      *        *-------------------------------------------------------*
      *        * Clienti movimentati nel periodo              [Output] *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-clm          pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Si/no forecast                               [Output] *
      *        *                                                       *
      *        * SIRI                                                  *
      *        *-------------------------------------------------------*
           05  w-det-qta-ord-snf          pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Scorta minima calcolata sul venduto                   *
      *        *-------------------------------------------------------*
           05  w-det-qta-fat-smv          pic s9(08)v9(03)            .
      ...
      *        *-------------------------------------------------------*
      *        * Percentuale di variazione media mensile       [Input] *
      *        *-------------------------------------------------------*
           05  w-det-sco-min-pdv          pic s9(02)                  .
      *        *-------------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Referenze relativa al programma fab435      *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       prn-sel-rec-200.
      *              *-------------------------------------------------*
      *              * Determinazione quantita' ordinate nel periodo   *
      *              * per il prodotto                                 *
      *              *-------------------------------------------------*
           move      01                   to   w-det-qta-ord-tpm      .
           move      rf-dcp-num-pro       to   w-det-qta-ord-cnm      .
           move      rr-dat-ini           to   w-det-qta-ord-dti      .
           move      rr-dat-fin           to   w-det-qta-ord-dtf      .
           move      w-ref-fab-430-mde    to   w-det-qta-ord-mde      .
           perform   det-qta-ord-000      thru det-qta-ord-999        .
      *              *-------------------------------------------------*
      *              * Se numero clienti movimentati inferiore al mi-  *
      *              * nimo richiesto : selezione non superata         *
      *              *-------------------------------------------------*
           if        w-det-qta-ord-clm    <    rr-ncl-mdc
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-300.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *              * Determinazione scorta minima sul venduto        *
      *              *-------------------------------------------------*
           ...
           move      w-det-sco-min-qsm    to   w-det-qta-fat-smv      .
      *              *-------------------------------------------------*
      *              * Determinazione scorta minima                    *
      *              *-------------------------------------------------*
           move      w-det-qta-ord-qfp    to   w-det-sco-min-qtt      .
           move      w-det-num-mcp-nme    to   w-det-sco-min-nme      .
           move      rr-pdv-mme           to   w-det-sco-min-pdv      .
           move      w-det-dat-ort-tam    to   w-det-sco-min-tag      .
           move      rf-dcp-dec-qta       to   w-det-sco-min-deq      .
      ...
      *              * nati                                            *
      *              *-------------------------------------------------*
           if        rf-fbs-sco-min (1)   not  < w-det-sco-min-smn and
                     rf-fbs-sco-min (1)   not  > w-det-sco-min-smx
                     move  "#"            to   w-cnt-prn-flg-sub
                     go to prn-sel-rec-999.
       prn-sel-rec-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-qta-ord-qfp      .
      *              *-------------------------------------------------*
      *              * Normalizzazione si/no forecast                  *
      *              *                                                 *
      *              * SIRI                                            *
      *              *-------------------------------------------------*
           move      spaces               to   w-det-qta-ord-snf      .
      *              *-------------------------------------------------*
      *              * Inizializzazione numero elementi in tabella     *
      *              * clienti movimentati                             *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-qta-ord-ele      .
       det-qta-ord-100.
      *              *-------------------------------------------------*
      *              * Start su file [ocr]                             *
      *              *-------------------------------------------------*
           ...
           move      w-det-qta-ord-tpm    to   rf-ocr-tip-mag         .
           move      w-det-qta-ord-cnm    to   rf-ocr-num-pro         .
           move      w-det-qta-ord-dti    to   rf-ocr-dat-doc         .
      ...
      *              *-------------------------------------------------*
           if        rf-ocr-cod-dpz       not  = rr-dpz-inu        or
                     rf-ocr-tip-mag       not  = w-det-qta-ord-tpm or
                     rf-ocr-num-pro       not  = w-det-qta-ord-cnm or
                     rf-ocr-dat-doc       >    w-det-qta-ord-dtf
                     go to det-qta-ord-200.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rf-ocr-tip-ord       not  = spaces
                     move  "*"            to   w-det-qta-ord-snf
                     go to det-qta-ord-120.
      *                  *---------------------------------------------*
      *                  * Test su tipo riga                           *
      *                  *---------------------------------------------*
           if        rf-ocr-tip-rig (1:1) not  = "P" or
                     rf-ocr-tip-rig (2:1) not  = " "
                     go to det-qta-ord-120.
      *                  *---------------------------------------------*
      *                  * Test su mese da escludere                   *
      *                  *---------------------------------------------*
           move      rf-ocr-dat-doc       to   w-det-qta-ord-wdt      .
           if        w-det-qta-ord-mde    not  = zero and
                     w-det-qta-ord-wme    =    w-det-qta-ord-mde
                     go to det-qta-ord-120.
      *                  *---------------------------------------------*
      *                  * Lettura record [oct]                        *
      *                  *---------------------------------------------*
      ...
      *              *                                                 *
      *              * Esclusione ordini Pro-Forma                     *
      *              *-------------------------------------------------*
           if        rf-oct-tip-ord       =    "P"
                     go to det-qta-ord-120.
      *              *-------------------------------------------------*
      *              * Aggiornamento quantita' ordinata nel periodo    *
      *              *-------------------------------------------------*
           add       rf-ocr-qta-ord       to   w-det-qta-ord-qfp      .
       det-qta-ord-140.
      *              *-------------------------------------------------*
      ...
      *                  * Ciclo di scansione                          *
      *                  *---------------------------------------------*
           move      zero                 to   w-det-qta-ord-c01      .
       det-qta-ord-142.
           add       1                    to   w-det-qta-ord-c01      .
           if        w-det-qta-ord-c01    >    w-det-qta-ord-ele
                     go to det-qta-ord-144.
           if        rf-ocr-cod-arc       =    w-det-qta-ord-cli
                                              (w-det-qta-ord-c01)
                     go to det-qta-ord-150.
           go to     det-qta-ord-142.
       det-qta-ord-144.
      *                  *---------------------------------------------*
      *                  * Bufferizzazione nuovo elemento              *
      *                  *---------------------------------------------*
           if        w-det-qta-ord-ele    <    w-det-qta-ord-max
                     add   1              to   w-det-qta-ord-ele      .
           move      rf-ocr-cod-arc       to   w-det-qta-ord-cli
                                              (w-det-qta-ord-ele)     .
       det-qta-ord-150.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      w-det-qta-ord-ele    to   w-det-qta-ord-clm      .
       det-qta-ord-999.
           exit.
      ...
      *              *-------------------------------------------------*
       ...
       det-sco-min-100.
      *              *-------------------------------------------------*
      *              * Aggiustamento quantita' media mensile con per-  *
      *              * tuale di variazione                             *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test se da eseguire                         *
      ...
      *                  * Calcolo                                     *
      *                  *---------------------------------------------*
           add       100                  to   w-det-sco-min-pdv
                                        giving w-det-sco-min-wpv      .
           multiply  w-det-sco-min-wpv    by   w-det-sco-min-wqt      .
           divide    100                  into w-det-sco-min-wqt
                                               rounded                .
       det-sco-min-200.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      077                  to   p-pos                  .
           move      w-det-qta-ord-snf    to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Unita' di misura                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      p-lnr                to   p-lin                  .
           move      113                  to   p-pos                  .
           move      w-det-qta-ord-clm    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      ...
      *
           if        rr-agg-ana           =    01
                     move  rf-fbs-sco-min (1)
                                          to   p-num
           else if   rr-agg-ana           =    02 and
                     w-det-sco-min-qsm    >    zero
                     move  w-det-sco-min-qsm
                                          to   p-num
           else if   rr-agg-ana           =    03 and
                     rf-fbs-sco-min (1)   =    zero
                     move  w-det-sco-min-qsm
                                          to   p-num
           else if   rr-agg-ana           =    04
                     move  zero           to   p-num
           else      move  rf-fbs-sco-min (1)
                                          to   p-num                  .
      *
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      *              * Scorta minima sul venduto                       *
      *              *-------------------------------------------------*
           move      "PF"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      09                   to   p-car                  .
           ...
           move      p-lnr                to   p-lin                  .
           move      131                  to   p-pos                  .
           move      w-det-qta-fat-smv    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           if        rr-agg-ana           =    03 and
                     rf-fbs-sco-min (1)   not  = zero
                     go to prn-liv-det-900.
           if        w-det-sco-min-qsm    =    rf-fbs-sco-min (1)
                     go to prn-liv-det-900.
           if        w-det-sco-min-qsm    =    zero
                     go to prn-liv-det-900.
       prn-liv-det-820.
      *                  *---------------------------------------------*
      *                  * Aggiornamento                               *
      ...
      *              *-------------------------------------------------*
           move      "DETERMINAZIONE SCORTA MINIMA PRODOTTI DI VENDITA D
      -              "A ORDINI CLIENTI"   to   w-cnt-tit-des-tit      .
           move      "DT"                 to   s-ope                  .
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      001                  to   p-pos                  .
           move      "    Codice             P/N                        
      -              " Descrizione               U.M. d'Acquisto   Tempo
      -              " Consegna   movim   attuale   su venduto  su ordin
      -              "ato"                to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *              *-------------------------------------------------*
