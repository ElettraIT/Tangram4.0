      ...
      *                       Ultima revisione:    NdK del 02/03/05    *
      *                    ------------------------------------------- *
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Dettaglio righe                            *
      *        *-------------------------------------------------------*
           05  w-exp-snx-drg.
               10  w-exp-snx-drg-num      pic  9(02)       value 2    .
               10  w-exp-snx-drg-lun      pic  9(02)       value 02   .
               10  w-exp-snx-drg-tbl.
      ...
      *                  * Dettaglio righe                             *
      *                  *---------------------------------------------*
           perform   acc-snx-drg-000      thru acc-snx-drg-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              * Dettaglio righe                                 *
      *              *-------------------------------------------------*
           perform   pmt-snx-drg-000      thru pmt-snx-drg-999        .
       pmt-ric-sel-999.
           exit.
      ...
      *    *===========================================================*
      *    * Visualizzazione prompt : Dettaglio delle righe            *
      *    *-----------------------------------------------------------*
       pmt-snx-drg-000.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
      ...
      *    *===========================================================*
      *    * Accettazione campo : Dettaglio righe                      *
      *    *-----------------------------------------------------------*
       acc-snx-drg-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-drg-lun    to   v-car                  .
           move      w-exp-snx-drg-num    to   v-ldt                  .
           move      "NS#"                to   v-msk                  .
           move      spaces               to   v-edm                  .
           move      17                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-drg-tbl    to   v-txt                  .
      *
           if        rr-snx-drg           =    "N"
                     move  01             to   v-num
           else if   rr-snx-drg           =    "S"
                     move  02             to   v-num
      ...
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-drg-999.
       acc-snx-drg-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           if        v-num                =    01
                     move  "N"            to   rr-snx-drg
           else if   v-num                =    02
                     move  "S"            to   rr-snx-drg
           else      move   spaces        to   rr-snx-drg             .
       acc-snx-drg-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
           if        rr-snx-drg           =    spaces
                     go to acc-snx-drg-100.
       acc-snx-drg-600.
      *              *-------------------------------------------------*
      *              * Dipendenze dall'impostazione                    *
      *              *-------------------------------------------------*
