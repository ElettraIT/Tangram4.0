      ...
      * -------------------------------------------------------------- *
      *                                                                *
      * La fase gep600, nella sua globalita', esegue i tipi di inter-  *
      ...
      * ----------  -------------------------------------------------- *
      *                                                                *
      * APCGLO      Situazione di portafoglio del cliente              *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   ANALISI DI PORTAFOGLIO PER CLIENTE   "       .
      ...
      *    *===========================================================*
      *    * Work-area per personalizzazioni per gestione magazzino    *
      *    *-----------------------------------------------------------*
       01  w-prs.
      *        *-------------------------------------------------------*
      ...
      *    *===========================================================*
      *    * Work-area per tipi operazione per gestione magazzino      *
      *    *-----------------------------------------------------------*
       01  w-top.
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-top-ele-max          pic  9(02)       value 50   .
      *            *---------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           if        w-cnt-pre-exe-pgm    not  = spaces
                     go to main-900.
      *              *-------------------------------------------------*
      *              * Esecuzione ciclo per la fase 'gep600'           *
      *              *-------------------------------------------------*
           perform   fas-gep-600-000      thru fas-gep-600-999        .
       main-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *
           move      "Situazione di portafoglio del cliente             
      -              " APCGLO     pgep600a  "
                                          to   w-tin-ele-wci          .
      ...
      *              *-------------------------------------------------*
           if        v-key                =    spaces or
                     v-key                =    "DO  "
                     go to fas-gep-600-300
           else if   v-key                =    "PRSC"
                     go to fas-gep-600-400
           else if   v-key                =    "NXSC"
                     go to fas-gep-600-450
           else if   v-key                =    "DOWN"
                     go to fas-gep-600-500
           else if   v-key                =    "EXIT"
                     go to fas-gep-600-250
           else      go to fas-gep-600-200.
       fas-gep-600-250.
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-key-num-int        =    zero
                     go to fas-gep-600-330.
           move      zero                 to   w-tin-ele-inx          .
       fas-gep-600-322.
           add       1                    to   w-tin-ele-inx          .
           if        w-tin-ele-inx        >    w-tin-ele-num
                     go to fas-gep-600-340.
           if        w-tin-num-tin
                    (w-tin-ele-inx)       =    w-key-num-int
                     go to fas-gep-600-350
           else      go to fas-gep-600-322.
       fas-gep-600-330.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        v-key                =    "DOWN"
                     go to fas-gep-600-630
           else if   v-key                =    "PRSC"
                     go to fas-gep-600-600
           else if   v-key                =    "NXSC"
                     go to fas-gep-600-610
           else if   v-key                =    "UP  "
                     go to fas-gep-600-620
           else if   v-key                =    spaces or
                     v-key                =    "DO  " or
                     v-key                =    "SLCT"
                     go to fas-gep-600-650
           else if   v-key                =    "EXIT"
                     go to fas-gep-600-660
           else      go to fas-gep-600-570.
       fas-gep-600-600.
      *                      *-----------------------------------------*
      *                      * Se Prsc                                 *
      *                      *-----------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-pel
                     go to fas-gep-600-626
           else      go to fas-gep-600-628.
       fas-gep-600-626.
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
           if        w-vis-pag-inx-tbl    =    w-vis-pag-inx-uel
                     go to fas-gep-600-636
           else      go to fas-gep-600-638.
       fas-gep-600-636.
      *                          *-------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        s-ves                =    spaces
                     go to fas-gep-600-725
           else      go to fas-gep-600-750.
       fas-gep-600-725.
      *              *-------------------------------------------------*
      *              * Se variabile esistente                          *
      *              *-------------------------------------------------*
