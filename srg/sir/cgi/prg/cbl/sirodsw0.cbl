      ...
      *            *---------------------------------------------------*
               ...
               10  w-slc-num-ost-pro      pic  9(07)                  .
               10  w-slc-num-ost-spl      pic  9(05)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Per pulizia stringhe barcode                          *
      *        *-------------------------------------------------------*
           05  w-det-pul-bcd.
               10  w-det-pul-bcd-alf      pic  x(80)                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-num                to   w-slc-num-ost-pro      .
      *                  *---------------------------------------------*
      *                  * Progressivo sub-riga                        *
      *                  *---------------------------------------------*
           move      "CV"                 to   p-ope                  .
           move      03                   to   p-car                  .
           move      w-exe-prr-ods        to   p-alf                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
           move      p-num                to   w-slc-num-ost-spl      .
      *                  *---------------------------------------------*
      *                  * Quantita'                                   *
      *                  *---------------------------------------------*
           move      "CV"                 to   p-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           if        w-slc-num-ost-pro    not  = zero
                     go to exe-cph-wrc-050.
           if        w-slc-num-ost-spl    not  = zero
                     go to exe-cph-wrc-050.
      *                  *---------------------------------------------*
      *                  * Messaggio in uscita                         *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-slc-num-ost-prt    to   rf-hbc-num-prt         .
           move      w-slc-num-ost-pro    to   rf-hbc-num-pro         .
           move      w-slc-num-ost-spl    to   rf-hbc-num-spl         .
           move      "sir/agb/fls/ioc/obj/iofhbc"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Test su protocollo e progressivo riga       *
      *                  *---------------------------------------------*
           if        w-slc-num-ost-prt    not  = zero and
                     w-slc-num-ost-spl    not  = zero and
      ...
      *              *-------------------------------------------------*
           if        w-slc-num-ost-prt    =    zero
                     go to exe-cph-dac-900.
           if        w-slc-num-ost-pro    =    zero
                     go to exe-cph-dac-900.
       exe-cph-dac-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rf-hbc-num-prt       not  = w-slc-num-ost-prt
                     go to  det-rig-pro-900.
           if        rf-hbc-num-pro       not  = w-slc-num-ost-pro
                     go to  det-rig-pro-900.
       det-rig-pro-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [hbc]                              *
      ...
      *              *-------------------------------------------------*
           move      w-slc-num-ost-spl    to   w-cmp-sub-rig-inx      .
       exe-cph-drc-cmp-200.
      ...
      *              * Progressivo sub-riga                            *
      *              *-------------------------------------------------*
           else if   w-all-str-cat (1)    =    "prr_ods"
                     move  w-all-str-cat (2)
                                          to   w-exe-prr-ods
      *              *-------------------------------------------------*
      *              * Codice numerico prodotto                        *
