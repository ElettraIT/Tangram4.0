      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Accoppiamento BFO -> ODS                    *
      *                                                                *
      *                    SIRI                                        *
      *                                                                *
      *================================================================*
      ...
      *            * Quantita' split                                   *
      *            *---------------------------------------------------*
               10  srt-qta-spl            pic s9(10)v9(03)            .
      *            *---------------------------------------------------*
      *            * Sigla bancale                                     *
      *            *---------------------------------------------------*
               10  srt-sgl-bnc            pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Flag di spunta                                    *
      *            *---------------------------------------------------*
               10  srt-flg-del            pic  x(01)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione presenza prodotto in ODS           *
      *        *-------------------------------------------------------*
           05  w-det-pro-osr.
      *            *---------------------------------------------------*
      *            * Codice prodotto numerico                          *
      *            *---------------------------------------------------*
               10  w-det-pro-osr-pro      pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Codice prodotto alfanumerico                      *
      *            *---------------------------------------------------*
               10  w-det-pro-osr-alf      pic  x(14)                  .
      *            *---------------------------------------------------*
      *            * Numero elementi rilevati                          *
      *            *---------------------------------------------------*
               10  w-det-pro-osr-ctr      pic  9(03)                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      zero                 to   w-slc-num-ods-prt      .
      *              *-------------------------------------------------*
      ...
      *                  * Protocollo BFO                              *
      *                  *---------------------------------------------*
           perform   ext-prm-prt-bfo-000  thru ext-prm-prt-bfo-999    .
      *                  *---------------------------------------------*
      *                  * Protocollo ODS                              *
      *                  *---------------------------------------------*
           perform   ext-prm-prt-ods-000  thru ext-prm-prt-ods-999    .
      *                  *---------------------------------------------*
      *                  * Codice alfanumerico prodotto                *
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        w-all-str-cat (1)    =    "num_bfo"
                     move  w-all-str-cat (2)
                                          to   w-exe-num-bfo
           else if   w-all-str-cat (1)    =    "num_ods"
                     move  w-all-str-cat (2)
                                          to   w-exe-num-ods
      ...
      *    * Estrazione parametri                                      *
      *    *                                                           *
      *    * Subroutine di eventuale estrazione protocollo BFO         *
      *    *-----------------------------------------------------------*
       ext-prm-prt-bfo-000.
      *              *-------------------------------------------------*
      ...
      *    * Estrazione parametri                                      *
      *    *                                                           *
      *    * Subroutine di eventuale estrazione protocollo ODS         *
      *    *-----------------------------------------------------------*
       ext-prm-prt-ods-000.
      *              *-------------------------------------------------*
      *              * Test su valore del campo in input               *
      *              *-------------------------------------------------*
           if        w-exe-num-ods        =    spaces
                     go to ext-prm-prt-ods-900.
           if        w-slc-num-ods-prt    not  = zero
                     go to ext-prm-prt-ods-900.
       ext-prm-prt-ods-300.
      *              *-------------------------------------------------*
      *              * Test su lunghezza del campo in input            *
      ...
      *              * Estremi BFO                                     *
      *              *-------------------------------------------------*
           perform   stp-tes-doc-bfo-000  thru stp-tes-doc-bfo-999    .
       stp-tes-doc-300.
      *              *-------------------------------------------------*
      *              * Estremi ODS                                     *
      *              *-------------------------------------------------*
______*    perform   stp-tes-doc-ods-000  thru stp-tes-doc-ods-999    .
       stp-tes-doc-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *    * Routine di stampa testata documento                       *
      *    *                                                           *
      *    * Subroutine per estremi ODS                                *
      *    *-----------------------------------------------------------*
       stp-tes-doc-ods-000.
      *              *-------------------------------------------------*
      *              * Test se da emettere                             *
      *              *-------------------------------------------------*
           if        w-slc-num-ods-prt    =    zero
                     go to stp-tes-doc-ods-900.
       stp-tes-doc-ods-010.
      *              *-------------------------------------------------*
      *              * Freccia giu'                                    *
      *              *-------------------------------------------------*
           display   "<h1>"                                           .
           display   "<img src='../../icons/down_data.png' width='40'>".
           display   "</h1>"                                          .
       stp-tes-doc-ods-050.
      *              *-------------------------------------------------*
      *              * Apertura tabella                                *
      ...
      *                  *---------------------------------------------*
           move      "RK"                 to   f-ope                  .
           move      "NUMPRT    "         to   f-key                  .
           move      w-slc-num-ods-prt    to   rf-ost-num-prt         .
           move      "pgm/ods/fls/ioc/obj/iofost"
                                          to   s-pat                  .
           call      "swd/mod/prg/obj/mfiltp"
                                         using s                      .
      ...
      *                  * Editing numero                              *
      *                  *---------------------------------------------*
           move      w-slc-num-ods-prt    to   w-slc-num-bfo-nds      .
           move      "ED"                 to   p-ope                  .
           move      "N"                  to   p-tip                  .
           move      06                   to   p-car                  .
           move      zero                 to   p-dec                  .
      ...
      *                  *---------------------------------------------*
       ...
       stp-tes-doc-ods-400.
      *              *-------------------------------------------------*
      *              * Estremi prodotto rilevati                       *
      *              * ___ DA IMPLEMENTARE ??? ___                     *
      *              *-------------------------------------------------*
       stp-tes-doc-ods-500.
      *              *-------------------------------------------------*
      *              * Test che l'ordine contenga il codice prodotto   *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Determinazione                              *
      *                  *---------------------------------------------*
           perform   det-pro-osr-000      thru det-pro-osr-999        .
           if        w-det-pro-osr-ctr    >    zero
                     go to stp-tes-doc-ods-800.
      *                  *---------------------------------------------*
      *                  * Messaggio                                   *
      *                  *---------------------------------------------*
           move      80                   to   w-all-str-lun          .
           move      03                   to   w-all-str-num          .
           move      "LA LISTA SELEZIONATA NON CONTIENE IL PN '"
                                          to   w-all-str-cat (1)      .
           move      w-det-pro-osr-alf    to   w-all-str-cat (2)      .
           move      "'"                  to   w-all-str-cat (3)      .
           perform   all-str-cat-000      thru all-str-cat-999        .
      *
       ...
       stp-tes-doc-ods-800.
      *              *-------------------------------------------------*
      *              * 'hidden' - Esito determinazione controllo pro-  *
      *              * dotto                                           *
      *              *-------------------------------------------------*
           move      "IH"                 to   h-ope                  .
           move      "snx"                to   h-nam                  .
      ...
      *              * Estremi ODS                                     *
      *              *-------------------------------------------------*
           perform   stp-tes-doc-ods-000  thru stp-tes-doc-ods-999    .
       stp-cor-doc-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  * Lettura prodotto                            *
      *                  *---------------------------------------------*
           move      rf-hbc-num-pro       to   w-let-arc-dcp-num      .
      ...
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-des    to   srt-des-key            .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico prodotto            *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-alf    to   srt-alf-key            .
      *                      *-----------------------------------------*
      *                      * Progressivo riga                        *
      *                      *-----------------------------------------*
           move      rf-hbc-num-spl       to   srt-rig-key            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Codice numerico prodotto                *
      *                      *-----------------------------------------*
           move      rf-hbc-num-pro       to   srt-num-pro            .
           move      rf-hbc-num-pro       to   w-det-pro-osr-pro      .
      *                      *-----------------------------------------*
      *                      * Codice alfanumerico prodotto            *
      *                      *-----------------------------------------*
           move      w-let-arc-dcp-alf    to   srt-alf-pro            .
           move      w-let-arc-dcp-alf    to   w-det-pro-osr-alf      .
      *                      *-----------------------------------------*
      *                      * Codice prodotto selezionato             *
      *                      *-----------------------------------------*
           if        rf-hbc-num-pro       =    w-exe-num-pro
      ...
      *                      * Quantita' split                         *
      *                      *-----------------------------------------*
           move      rf-hbc-qta-spl       to   srt-qta-spl            .
      *                      *-----------------------------------------*
      *                      * Sigla bancale                           *
      *                      *-----------------------------------------*
           move      rf-hbc-sgl-bnc       to   srt-sgl-bnc            .
      *                      *-----------------------------------------*
      *                      * Flag di spunta                          *
      *                      *-----------------------------------------*
           move      rf-hbc-flg-del       to   srt-flg-del            .
       stp-cor-doc-inp-700.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      srt-num-pro          to   w-det-qta-brc-pro      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "9"                  to   p-edm                  .
           move      w-slc-num-ods-prt    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Emissione                                   *
      ...
      *              * Modulo                                          *
      *              *-------------------------------------------------*
           display   "<form name='bfo_0B1' id='bfo_0B1' method='post' ac
      -              "tion=''>"                                       .
       int-pag-sta-300.
      *              *-------------------------------------------------*
      *              * Allineamento                                    *
      ...
      *              * Protocollo BFO                                  *
      *              *-------------------------------------------------*
           perform   int-pag-sta-bfo-000  thru int-pag-sta-bfo-999    .
      *              *-------------------------------------------------*
      *              * Protocollo ODS                                  *
      *              *-------------------------------------------------*
           perform   int-pag-sta-ods-000  thru int-pag-sta-ods-999    .
      *              *-------------------------------------------------*
      *              * Codice prodotto                                 *
      *              *-------------------------------------------------*
______*    perform   int-pag-sta-pro-000  thru int-pag-sta-pro-999    .
      *              *-------------------------------------------------*
      *              * Bottone di reset                                *
      *              *-------------------------------------------------*
      ...
      *    * Intestazione                                              *
      *    *                                                           *
      *    * Subroutine per accettazione protocollo BFO                *
      *    *-----------------------------------------------------------*
       int-pag-sta-bfo-000.
      *              *-------------------------------------------------*
      *              * Apertura cella                                  *
      *              *-------------------------------------------------*
           display   "<td id='cel_bfo' name='cel_bfo' align='center'>".
      *              *-------------------------------------------------*
      *              * Prompt                                          *
      *              *-------------------------------------------------*
      ...
      *    * Intestazione                                              *
      *    *                                                           *
      *    * Subroutine per accettazione protocollo ODS                *
      *    *-----------------------------------------------------------*
       int-pag-sta-ods-000.
      *              *-------------------------------------------------*
      *              * Apertura cella                                  *
      *              *-------------------------------------------------*
           display   "<td id='cel_ods' name='cel_ods' align='center'>".
      *              *-------------------------------------------------*
      *              * Prompt                                          *
      *              *-------------------------------------------------*
...
______*                         delimited by   spaces
      ...
      *    *===========================================================*
      *    * Determinazione presenza prodotto in ODS                   *
      *    *-----------------------------------------------------------*
       det-pro-osr-000.
      *              *-------------------------------------------------*
      *              * Normalizzazione contatori                       *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-pro-osr-ctr      .
       det-pro-osr-100.
      *              *-------------------------------------------------*
      *              * Start su [osr]                                  *
      *              *-------------------------------------------------*
           ...
           move      "NUMPRT    "         to   f-key                  .
           move      "NL"                 to   f-cfr                  .
           move      w-slc-num-ods-prt    to   rf-osr-num-prt         .
      ...
      *                  * Test su protocollo                          *
      *                  *---------------------------------------------*
           if        rf-osr-num-prt       not  = w-slc-num-ods-prt
                     go to  det-pro-osr-900.
       det-pro-osr-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [osr]                              *
      ...
      *                  *---------------------------------------------*
           if        rf-osr-tip-rig       not  = "P    "
                     go to  det-pro-osr-200.
      *                  *---------------------------------------------*
      *                  * Test su codice numerico prodotto            *
      *                  *---------------------------------------------*
           if        rf-osr-num-pro       not  = w-det-pro-osr-pro
                     go to det-pro-osr-200.
       det-pro-osr-600.
      *              *-------------------------------------------------*
      *              * Incremento contatore                            *
      *              *-------------------------------------------------*
           add       1                    to   w-det-pro-osr-ctr      .
       det-pro-osr-800.
      *              *-------------------------------------------------*
      *              * Riciclo a record successivo                     *
      *              *-------------------------------------------------*
