      ...
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Ricerca su registrazioni barcode            *
      *                                                                *
      *                    VERSIONE SENZA ROTTURA CLIENTE - PRODOTTO   *
      *                                                                *
      *                    SIRI                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-key.
      *            *---------------------------------------------------*
      *            * Codice cliente per ordinamento                    *
      *            *---------------------------------------------------*
               10  srt-cli-key            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Protocollo ordine per ordinamento                 *
      *            *---------------------------------------------------*
               10  srt-prt-key            pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Codice numerico prodotto per ordinamento          *
      *            *---------------------------------------------------*
               10  srt-pro-key            pic  9(07)                  .
      *            *---------------------------------------------------*
      *            * Split per ordinamento                             *
      *            *---------------------------------------------------*
               10  srt-spl-key            pic  9(05)                  .
      *        *-------------------------------------------------------*
      *        * Dati                                                  *
      *        *-------------------------------------------------------*
           05  srt-dat.
      ...
      *            * Split prodotto                                    *
      *            *---------------------------------------------------*
               10  srt-num-spl            pic  9(05)                  .
      *            *---------------------------------------------------*
      *            * Quantita' split                                   *
      *            *---------------------------------------------------*
               10  srt-qta-spl            pic s9(10)v9(03)            .
      *            *---------------------------------------------------*
      *            * Informazioni dedotte da barcode produttore        *
      *            *---------------------------------------------------*
               10  srt-dat-bcd occurs 06.
                   15  srt-sez-bcd        pic  x(80)                  .
      ...
      *        *-------------------------------------------------------*
           05  w-exe-cod-cli              pic  x(07)                  .
           05  w-exe-cnv-cli              pic  9(07)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Per determinazione riferimenti bolla                  *
      *        *-------------------------------------------------------*
           05  w-det-rif-bol.
      *            *---------------------------------------------------*
      *            * Protocollo lista                                  *
      *            *---------------------------------------------------*
               10  w-det-rif-bol-prt      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Numero bolla                                      *
      *            *---------------------------------------------------*
               10  w-det-rif-bol-ndo      pic  9(11)                  .
      *            *---------------------------------------------------*
      *            * Data bolla                                        *
      *            *---------------------------------------------------*
               10  w-det-rif-bol-ddo      pic  9(07)                  .
      *        *-------------------------------------------------------*
      *        * Per determinazione barcode                            *
      *        *-------------------------------------------------------*
           05  w-det-qta-brc.
      *            *---------------------------------------------------*
      *            * Barcode per la riga                               *
      ...
      *    *-----------------------------------------------------------*
       01  w-rot.
      *        *-------------------------------------------------------*
      *        * Rottura su cliente, lista, prodotto                   *
      *        *-------------------------------------------------------*
           05  w-rot-clp.
               10  w-rot-cod-arc          pic  9(07)                  .
               10  w-rot-num-prt          pic  9(11)                  .
               10  w-rot-num-pro          pic  9(07)                  .
      ...
      *              *-------------------------------------------------*
______*    perform   stp-tes-doc-000      thru stp-tes-doc-999        .
       rou-stp-doc-300.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           display   "<table class='bordotab' id='mxport' name='mxport' 
      -              "width=100%>"                                    .
      *                  *---------------------------------------------*
      *                  * Apertura 'thead'                            *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *                  *---------------------------------------------*
      *                  * Literal per Ragione sociale cliente         *
      *                  *---------------------------------------------*
           move      "TD"                 to   h-ope                  .
           move      "th"                 to   h-sub                  .
           ...
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *                  *---------------------------------------------*
      *                  * Literal per numero Ordine di spedizione     *
      *                  *---------------------------------------------*
           move      "TD"                 to   h-ope                  .
           move      "th"                 to   h-sub                  .
           move      "N LISTA"            to   h-alf                  .
           move      "1"                  to   h-col                  .
           move      "C"                  to   h-all                  .
           move      "S"                  to   h-wdt                  .
           move      "B"                  to   h-stl                  .
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *                  *---------------------------------------------*
      *                  * Literal per numero Bolla                    *
      *                  *---------------------------------------------*
           move      "TD"                 to   h-ope                  .
           move      "th"                 to   h-sub                  .
           move      "N BOLLA"            to   h-alf                  .
           move      "1"                  to   h-col                  .
           move      "C"                  to   h-all                  .
           move      "S"                  to   h-wdt                  .
           move      "B"                  to   h-stl                  .
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *                  *---------------------------------------------*
      *                  * Literal per data Bolla                      *
      *                  *---------------------------------------------*
           move      "TD"                 to   h-ope                  .
           move      "th"                 to   h-sub                  .
           move      "DATA BOLLA"         to   h-alf                  .
           move      "1"                  to   h-col                  .
           move      "C"                  to   h-all                  .
           move      "S"                  to   h-wdt                  .
           move      "B"                  to   h-stl                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      1240101              to   rf-osr-dat-doc         .
      ...
      *              *-------------------------------------------------*
           ...
           move      rf-osr-num-pro       to   rf-hbc-num-pro         .
      ...
      *                  * Test su prodotto                            *
      *                  *---------------------------------------------*
           if        rf-hbc-num-pro       not  = rf-osr-num-pro
                     go to  stp-cor-doc-inp-200.
       stp-cor-doc-inp-540.
      *              *-------------------------------------------------*
      *              * Selezioni su [hbc]                              *
      ...
      *                      * Codice cliente                          *
      *                      *-----------------------------------------*
           move      rf-osr-cod-arc       to   srt-cli-key            .
      *                      *-----------------------------------------*
      *                      * Protocollo ordine                       *
      *                      *-----------------------------------------*
      ...
      *                      * Split                                   *
      *                      *-----------------------------------------*
           move      rf-hbc-num-spl       to   srt-spl-key            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      ...
      *                      * Split prodotto                          *
      *                      *-----------------------------------------*
           move      rf-hbc-num-spl       to   srt-num-spl            .
      *                      *-----------------------------------------*
      *                      * Quantita' split prodotto                *
      *                      *-----------------------------------------*
           move      rf-hbc-qta-spl       to   srt-qta-spl            .
      *                      *-----------------------------------------*
      *                      * Dati barcode                            *
      *                      *-----------------------------------------*
           move      rf-hbc-sez-bcd (1)   to   srt-sez-bcd (1)        .
           move      rf-hbc-sez-bcd (2)   to   srt-sez-bcd (2)        .
           move      rf-hbc-sez-bcd (3)   to   srt-sez-bcd (3)        .
           move      rf-hbc-sez-bcd (4)   to   srt-sez-bcd (4)        .
           move      rf-hbc-sez-bcd (5)   to   srt-sez-bcd (5)        .
           move      rf-hbc-sez-bcd (6)   to   srt-sez-bcd (6)        .
       stp-cor-doc-inp-700.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-cor-doc-inp-800.
      *              *-------------------------------------------------*
      *              * Riciclo a record [osr] successivo               *
      *              *-------------------------------------------------*
           go to     stp-cor-doc-inp-520.
       stp-cor-doc-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-cor-doc-out-300.
      *              *-------------------------------------------------*
      *              * Eventuale rottura su lista                      *
      *              *-------------------------------------------------*
      
      
           go to     stp-cor-doc-out-400.
      ...
      *                  *---------------------------------------------*
           if        w-rot-clp            =    zero
                     go to stp-cor-doc-out-320.
           if        w-rot-cod-arc        =    srt-cod-cli and
                     w-rot-num-prt        =    srt-num-prt and
                     w-rot-num-pro        =    srt-num-pro
                     go to stp-cor-doc-out-340
           else      go to stp-cor-doc-out-320.
       stp-cor-doc-out-320.
      *                  *---------------------------------------------*
      *                  * Memorizzazione nuovo elemento               *
      *                  *---------------------------------------------*
           move      srt-cod-cli          to   w-rot-cod-arc          .
           move      srt-num-prt          to   w-rot-num-prt          .
           move      srt-num-pro          to   w-rot-num-pro          .
      *                  *---------------------------------------------*
      *                  * A emissione riga                            *
      *                  *---------------------------------------------*
           go to     stp-cor-doc-out-400.
      ...
      *                  * Determinazione                              *
      *                  *---------------------------------------------*
           move      srt-num-prt          to   w-det-rif-bol-prt      .
           perform   det-rif-bol-000      thru det-rif-bol-999        .
      *                  *---------------------------------------------*
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           move      "ED"                 to   p-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           move      "D"                  to   p-tip                  .
           move      ">"                  to   p-edm                  .
           move      w-det-rif-bol-ddo    to   p-dat                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Emissione                                   *
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-dat-bcd (1)      to   w-big-str-cat (1)      .
           move      srt-dat-bcd (2)      to   w-big-str-cat (2)      .
           move      srt-dat-bcd (3)      to   w-big-str-cat (3)      .
           move      srt-dat-bcd (4)      to   w-big-str-cat (4)      .
           move      srt-dat-bcd (5)      to   w-big-str-cat (5)      .
           move      srt-dat-bcd (6)      to   w-big-str-cat (6)      .
      ...
      *              * Modulo                                          *
      *              *-------------------------------------------------*
           display   "<form name='ods_01B' id='ods_01B' method='post' ac
      -              "tion=''>"                                       .
       int-pag-sta-300.
      *              *-------------------------------------------------*
      *              * Allineamento                                    *
      ...
      *              *-------------------------------------------------*
           perform   int-pag-sta-des-000  thru int-pag-sta-des-999    .
      *              *-------------------------------------------------*
      *              * Chiusura riga                                   *
      *              *-------------------------------------------------*
           move      "ET"                 to   h-ope                  .
      ...
      *              * Apertura cella                                  *
      *              *-------------------------------------------------*
           display   "<td id='cel_des' name='cel_des' align='center'>".
      *              *-------------------------------------------------*
      *              * Prompt                                          *
      *              *-------------------------------------------------*
      ...
      *              * Lettura                                         *
      *              *-------------------------------------------------*
           move      w-exe-num-pro        to   w-let-arc-dcp-num      .
           perform   let-arc-dcp-000      thru let-arc-dcp-999        .
      *
           if        w-exe-num-pro        =    zero or
      ...
      *              *-------------------------------------------------*
           move      "HT"                 to   h-ope                  .
           move      "{SIRI} RICERCA PER PRODOTTO"
                                          to   h-alf                  .
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *              *-------------------------------------------------*
...
______*    move      "jquery_3.5.1.js"          to   h-alf                  .
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *              *-------------------------------------------------*
...
______*    display   "<hr>"                                           .
      ...
      *    *===========================================================*
      *    * Determinazione riferimenti bolla                          *
      *    *-----------------------------------------------------------*
       det-rif-bol-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni iniziali                        *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-rif-bol-ndo      .
           move      zero                 to   w-det-rif-bol-ddo      .
       det-rif-bol-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      w-det-rif-bol-prt    to   rf-bir-ods-prt         .
      ...
      *                  *---------------------------------------------*
       ...
       det-rif-bol-300.
      *              *-------------------------------------------------*
      *              * Test max su archivio [bir]                      *
      *              *-------------------------------------------------*
           if        rf-bir-cod-dpz       not  = 01
                     go to det-rif-bol-900.
           if        rf-bir-ods-prt       not  = w-det-rif-bol-prt
                     go to det-rif-bol-900.
       det-rif-bol-400.
      *              *-------------------------------------------------*
      *              * Selezioni                                       *
      ...
      *              *-------------------------------------------------*
           move      rf-bir-num-doc       to   w-det-rif-bol-ndo      .
           move      rf-bir-dat-doc       to   w-det-rif-bol-ddo      .
       det-rif-bol-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     det-rif-bol-999.
       det-rif-bol-999.
           exit.
