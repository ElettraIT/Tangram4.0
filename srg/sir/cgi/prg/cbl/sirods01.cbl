      ...
      *                       Ultima revisione:    NdK del 15/07/24    *
      *                    ------------------------------------------- *
      ...
      *                  *---------------------------------------------*
           ...
           move      srt-num-pro          to   w-det-cst-pro-pro
                                              (w-det-cst-pro-ctr)     .
           move      srt-qta-ven          to   w-det-cst-pro-qta
                                              (w-det-cst-pro-ctr)     .
      *                  *---------------------------------------------*
      *                  * A riciclo                                   *
      *                  *---------------------------------------------*
      ...
      *                  * Elemento trovato                            *
      *                  *---------------------------------------------*
           add       srt-qta-ven          to   w-det-cst-pro-qta
                                              (w-det-cst-pro-ctr)     .
      *                  *---------------------------------------------*
      *                  * A riciclo                                   *
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-det-cst-pro-pro
                    (w-det-cst-pro-c01)   to   d-sld-mag-num-mag      .
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "9"                  to   p-edm                  .
           move      w-slc-num-ost-prt    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Emissione                                   *
      ...
      *              *-------------------------------------------------*
       ...
       int-pag-sta-600.
      *              *-------------------------------------------------*
      *              * Determinazione ultimo numero documento o imma-  *
      *              * gine caricato                                   *
      *              *-------------------------------------------------*
           move      w-slc-num-ost-prt    to   w-det-prg-img-prt      .
           perform   det-prg-img-000      thru det-prg-img-999        .
      *              *-------------------------------------------------*
      *              * Accesso alle immagini eventuali                 *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Editing                                     *
      *                  *---------------------------------------------*
           if        w-det-prg-img-num    <    1
                     go to     int-pag-sta-800.
      *                  *---------------------------------------------*
      *                  * Bottone di accesso alle immagini            *
      *                  *---------------------------------------------*
           display   "<td id='cel_dir' name='cel_dir'>"               .
           display   "<button type='button' id='dir' name='dir' "     .
           display   "/>"                                             .
           display   "<img src='../../icons/glass.png' width='40'>"   .
           display   "</button>"                                      .
           display   "</td>"                                          .
       int-pag-sta-800.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *              *-------------------------------------------------*
      *              * Box di dialogo per elenco allegati              *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           display   "<tr>"                                           .
           display   "<td class='td_nb'>"                             .
           display   "<input type='button' id='upl_cnf' name='upl_cnf' v
      -              "alue='CARICA' />"                               .
           display   "</td>"                                          .
           display   "</tr>"                                          .
      *              *-------------------------------------------------*
...
______*                         delimited by   spaces
      ...
      *              *-------------------------------------------------*
           move      "HT"                 to   h-ope                  .
           move      "{SIRI} ORDINI DI SPEDIZIONE"
                                          to   h-alf                  .
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *              *-------------------------------------------------*
