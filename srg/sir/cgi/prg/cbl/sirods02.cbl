      ...
      *                                   Fase:    sirods              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 04/06/23    *
      ...
      *        *-------------------------------------------------------*
           05  w-let-rec-hbc.
               ...
               10  w-let-rec-hbc-pro      pic  9(07)                  .
               10  w-let-rec-hbc-spl      pic  9(05)                  .
      ...
      *              *-------------------------------------------------*
           if        w-all-str-cat (1)    =    "prt_ods"
                     ...
                     move  w-all-str-cat (2)
                                          to   w-exe-alf-pro
           else if   w-all-str-cat (1)    =    "sts_ods"
                     move  w-all-str-cat (2)
                                          to   w-exe-sts-ods          .
       ext-prm-ass-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           perform   stp-cor-doc-osr-000  thru stp-cor-doc-osr-999    .
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           add       rf-osr-qta-ven       to   w-det-qta-brc-qta      .
       stp-cor-doc-osr-800.
      *              *-------------------------------------------------*
      *              * A riciclo                                       *
      *              *-------------------------------------------------*
...
______*    move      p-edt                to   w-all-str-cat (3)      .
      ...
      *              *-------------------------------------------------*
           move      "IH"                 to   h-ope                  .
           move      "sts_ods"            to   h-nam                  .
           move      w-exe-sts-ods        to   h-alf                  .
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
       stp-cor-doc-hid-900.
      *              *-------------------------------------------------*
      ...
      *
           if        w-exe-sts-ods        =    "A" or
                     w-exe-sts-ods        =    spaces
                     display   "/>" 
           else      display   " disabled />"                         .
      *
      ...
      *              *-------------------------------------------------*
           move      "HT"                 to   h-ope                  .
           move      "{SIRI} ORDINI DI SPEDIZIONE - PRODOTTO"
                                          to   h-alf                  .
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *              *-------------------------------------------------*
...
______*    move      "../../siri/jsc/"    to   h-prm                  .
______*    move      "html5-qrcode.min.js"
______*                                   to   h-alf                  .
