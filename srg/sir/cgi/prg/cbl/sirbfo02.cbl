      ...
      *                                   Fase:    sirbfo              *
      *                    ------------------------------------------- *
      *                     Versione originale:    001 del 24/05/24    *
      *                       Ultima revisione:    NdK del 23/09/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Bolla di entrata merce per prodotto         *
      *                                                                *
      *                    SIRI                                        *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  w-exe-prt-bfo              pic  x(20)                  .
           05  w-exe-alf-pro              pic  x(14)                  .
           05  w-exe-num-pro              pic  9(07)                  .
           05  w-exe-sts-bfo              pic  x(01)                  .
      *        *-------------------------------------------------------*
      *        * Comodi per rottura su codice prodotto                 *
      *        *-------------------------------------------------------*
           05  w-exe-rot-pro              pic  9(07)                  .
           05  w-exe-rot-qta              pic  9(10)v9(03)            .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-det-qta-brc-qta      pic  9(10)v9(03)            .
      *            *---------------------------------------------------*
      *            * Quantita' controllata                             *
      *            *---------------------------------------------------*
               10  w-det-qta-brc-qct      pic  9(10)v9(03)            .
      *            *---------------------------------------------------*
      *            * Quantita' mancante                                *
      *            *---------------------------------------------------*
               10  w-det-qta-brc-qcm      pic s9(10)v9(03)            .
      *            *---------------------------------------------------*
      *            * Quantita' controllata ultima riga di split        *
      *            *---------------------------------------------------*
               10  w-det-qta-brc-qcu      pic  9(10)v9(03)            .
      *            *---------------------------------------------------*
      *            * Quantita' per la riga                             *
      *            *---------------------------------------------------*
               10  w-det-qta-brc-qpr      pic  9(10)v9(03)            .
      *            *---------------------------------------------------*
      *            * Barcode per la riga                               *
      *            *---------------------------------------------------*
               10  w-det-qta-brc-bcd occurs 06.
                   15  w-det-qta-brc-sez  pic  x(80)                  .
               10  w-det-qta-brc-bcw      pic  x(480)                 .
      *            *---------------------------------------------------*
      *            * Bancale per la riga                               *
      *            *---------------------------------------------------*
               10  w-det-qta-brc-bnc      pic  x(20)                  .
               10  w-det-qta-brc-dbn      pic  x(20)                  .
      *            *---------------------------------------------------*
      *            * Quantita' bancali                                 *
      *            *---------------------------------------------------*
               10  w-det-qta-brc-qbn      pic  9(03)                  .
               10  w-det-qta-brc-qbr      pic  x(10)                  .
      *            *---------------------------------------------------*
      *            * Note per la riga                                  *
      *            *---------------------------------------------------*
               10  w-det-qta-brc-ann      pic  x(256)                 .
      *            *---------------------------------------------------*
      *            * Flag di cancellazione                             *
      *            *---------------------------------------------------*
               10  w-det-qta-brc-flg      pic  x(01)                  .
      ...
      *              *-------------------------------------------------*
           if        w-all-str-cat (1)    =    "prt_bfo"
                     ...
                     move  w-all-str-cat (2)
                                          to   w-exe-alf-pro
           else if   w-all-str-cat (1)    =    "sts_bfo"
                     move  w-all-str-cat (2)
                                          to   w-exe-sts-bfo          .
       ext-prm-ass-900.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
       ...
       stp-cor-doc-050.
      *              *-------------------------------------------------*
      *              * Lettura righe prodotto                          *
      *              *-------------------------------------------------*
           perform   stp-cor-doc-bfr-000  thru stp-cor-doc-bfr-999    .
      *              *-------------------------------------------------*
      *              * Visualizzazione dati prodotto                   *
      *              *-------------------------------------------------*
      ...
      *
           ...
           move      w-exe-num-pro        to   rf-hbc-num-pro         .
      ...
      *              *-------------------------------------------------*
           if        rf-hbc-num-prt       not  = w-slc-num-bfo-pr8
                     go to  stp-cor-doc-800.
           if        rf-hbc-num-pro       not  = w-exe-num-pro
                     go to  stp-cor-doc-800.
       stp-cor-doc-400.
      *              *-------------------------------------------------*
      *              * Selezioni su [hbc]                              *
      ...
      *              *-------------------------------------------------*
           move      rf-hbc-qta-spl       to   w-det-qta-brc-qpr      .
      *
           move      rf-hbc-sez-bcd (1)   to   w-det-qta-brc-bcd (1)  .
           move      rf-hbc-sez-bcd (2)   to   w-det-qta-brc-bcd (2)  .
           move      rf-hbc-sez-bcd (3)   to   w-det-qta-brc-bcd (3)  .
           move      rf-hbc-sez-bcd (4)   to   w-det-qta-brc-bcd (4)  .
           move      rf-hbc-sez-bcd (5)   to   w-det-qta-brc-bcd (5)  .
           move      rf-hbc-sez-bcd (6)   to   w-det-qta-brc-bcd (6)  .
      *
           move      rf-hbc-sgl-bnc       to   w-det-qta-brc-bnc      .
           move      rf-hbc-ann-spl       to   w-det-qta-brc-ann      .
           move      rf-hbc-flg-del       to   w-det-qta-brc-flg      .
      *
           if        rf-hbc-sgl-bnc       not  = spaces
                     move  rf-hbc-sgl-bnc to   w-det-qta-brc-dbn      .
      *
      ...
      *                  *---------------------------------------------*
           if        w-det-qta-brc-qct    not  < w-det-qta-brc-qta
      ...
      *                  *---------------------------------------------*
      *                      *-----------------------------------------*
      *                      * Se controllata a zero (prima riga), si  *
      *                      * propone tutta la quantita' da spedire,  *
      *                      * altrimenti la quantita' dell'ultima ri- *
      *                      * ga trattata                             *
      *                      *-----------------------------------------*
           if        w-det-qta-brc-qct    =    zero
                     move  w-det-qta-brc-qta
                                          to   w-det-qta-brc-qpr
           else      move  w-det-qta-brc-qcu
                                          to   w-det-qta-brc-qpr      .
      *                      *-----------------------------------------*
      *                      * Determinazione quantita' mancante       *
      *                      *-----------------------------------------*
           move      w-det-qta-brc-qta    to   w-det-qta-brc-qcm      .
           subtract  w-det-qta-brc-qct    from w-det-qta-brc-qcm      .
      *                      *-----------------------------------------*
      *                      * Se la quantita' di default supera la    *
      *                      * quantita' mancante, si propone que-     *
      *                      * st'ultima come default                  *
      *                      *-----------------------------------------*
           if        w-det-qta-brc-qpr    >    w-det-qta-brc-qcm
                     move  w-det-qta-brc-qcm
                                          to   w-det-qta-brc-qpr      .
      *                      *-----------------------------------------*
      *                      * Se comunque il default e' ancora a zero *
      *                      * si propone il lotto di vendita          *
      *                      *-----------------------------------------*
           if        w-det-qta-brc-qpr    =    zero
                     move  rf-dcp-lot-ven to   w-det-qta-brc-qpr      .
      *                  *---------------------------------------------*
      *                  * Normalizzazione barcode e note              *
      *                  *---------------------------------------------*
           move      spaces               to   w-det-qta-brc-bcd (1)  .
           move      spaces               to   w-det-qta-brc-bcd (2)  .
           move      spaces               to   w-det-qta-brc-bcd (3)  .
           move      spaces               to   w-det-qta-brc-bcd (4)  .
           move      spaces               to   w-det-qta-brc-bcd (5)  .
           move      spaces               to   w-det-qta-brc-bcd (6)  .
      *
           move      spaces               to   w-det-qta-brc-bnc      .
           move      spaces               to   w-det-qta-brc-ann      .
           move      spaces               to   w-det-qta-brc-flg      .
      *                  *---------------------------------------------*
      *                  * Emissione                                   *
      *                  *---------------------------------------------*
           perform   stp-cor-doc-sbr-000  thru stp-cor-doc-sbr-999    .
      ...
      *    * Stampa corpo documento                                    *
      *    *                                                           *
      *    * Subroutine di scansione documento                         *
      *    *-----------------------------------------------------------*
       stp-cor-doc-bfr-000.
      *              *-------------------------------------------------*
      *              * Normalizzazioni preliminari                     *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-qta-brc-qta      .
       stp-cor-doc-bfr-100.
      *              *-------------------------------------------------*
      *              * Start su [osr]                                  *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-cor-doc-bfr-500.
      *              *-------------------------------------------------*
      *              * Accumulo della quantita'                        *
      *              *-------------------------------------------------*
           add       rf-bfr-qta-acq       to   w-det-qta-brc-qta      .
       stp-cor-doc-bfr-800.
      *              *-------------------------------------------------*
      *              * A riciclo                                       *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
       ...
       stp-cor-doc-sbr-120.
      *              *-------------------------------------------------*
      *              * Test se riga inibita                            *
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Test                                        *
      *                  *---------------------------------------------*
           if        w-det-qta-brc-flg    not  = "S"
                     go to stp-cor-doc-sbr-150.
      *                  *---------------------------------------------*
      *                  * Visualizzazione dati                        *
      *                  *---------------------------------------------*
           perform   stp-cor-doc-vis-000  thru stp-cor-doc-vis-999    .
      *                  *---------------------------------------------*
      *                  * Oltre                                       *
      *                  *---------------------------------------------*
           go to     stp-cor-doc-sbr-600.
       stp-cor-doc-sbr-150.
      *              *-------------------------------------------------*
      *              * Accettazione bancale                            *
      *              *-------------------------------------------------*
           perform   stp-cor-doc-bnc-000  thru stp-cor-doc-bnc-999    .
       stp-cor-doc-sbr-200.
      *              *-------------------------------------------------*
      ...
      *    * Stampa corpo documento                                    *
      *    *                                                           *
      *    * Subroutine di visualizzazione dati riga inibita           *
      *    *-----------------------------------------------------------*
       stp-cor-doc-vis-000.
      *              *-------------------------------------------------*
      *              * Bancale                                         *
      *              *-------------------------------------------------*
           move      "TD"                 to   h-ope                  .
           move      "td"                 to   h-sub                  .
           move      w-det-qta-brc-bnc    to   h-alf                  .
           move      "1"                  to   h-col                  .
           move      "L"                  to   h-all                  .
           move      "S"                  to   h-wdt                  .
           move      "g"                  to   h-stl                  .
      ...
      *                  * Assemblaggio                                *
      *                  *---------------------------------------------*
           move      480                  to   w-big-str-lun          .
           move      06                   to   w-big-str-num          .
           move      w-det-qta-brc-bcd (1)
                                          to   w-big-str-cat (1)      .
           move      w-det-qta-brc-bcd (2)
                                          to   w-big-str-cat (2)      .
           move      w-det-qta-brc-bcd (3)
                                          to   w-big-str-cat (3)      .
           move      w-det-qta-brc-bcd (4)
                                          to   w-big-str-cat (4)      .
           move      w-det-qta-brc-bcd (5)
                                          to   w-big-str-cat (5)      .
           move      w-det-qta-brc-bcd (6)
                                          to   w-big-str-cat (6)      .
           perform   big-str-cat-000      thru big-str-cat-999        .
           move      w-big-str-alf        to   w-det-qta-brc-bcw      .
      *                  *---------------------------------------------*
      *                  * Emissione                                   *
      *                  *---------------------------------------------*
           display   "<td>"                                           .
           display   w-det-qta-brc-bcw                                .
           display   "</td>"                                          .
      *              *-------------------------------------------------*
      *              * Quantita'                                       *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<BD"                to   p-edm                  .
           move      w-det-qta-brc-qpr    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                  *---------------------------------------------*
      *                  * Emissione                                     *
      ...
      *              *-------------------------------------------------*
           move      "TD"                 to   h-ope                  .
           move      "td"                 to   h-sub                  .
           move      w-det-qta-brc-ann    to   h-alf                  .
           move      "1"                  to   h-col                  .
           move      "L"                  to   h-all                  .
           move      "S"                  to   h-wdt                  .
           move      "g"                  to   h-stl                  .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
______*    move      p-edt                to   w-all-str-cat (3)      .
           move      p-edt                to   w-exe-rwi-idx          .
           go to     stp-cor-doc-rwi-900.
      ...
      *    * Stampa corpo documento                                    *
      *    *                                                           *
      *    * Subroutine di accettazione bancale                        *
      *    *-----------------------------------------------------------*
       stp-cor-doc-bnc-000.
      *              *-------------------------------------------------*
      *              * Eventuale default sigla bancale                 *
      *              *-------------------------------------------------*
           if        w-det-qta-brc-bnc    not  = spaces
                     go to stp-cor-doc-bnc-100.
           move      w-det-qta-brc-dbn    to   w-det-qta-brc-bnc      .
       stp-cor-doc-bnc-100.
      *              *-------------------------------------------------*
      *              * Apertura cella                                  *
      *              *-------------------------------------------------*
           display   "<td width=10% id='cel_bnc' name ='cel_bnc'>"    .
      *              *-------------------------------------------------*
      *              * Accettazione                                    *
      *              *-------------------------------------------------*
           display   "<input type='text'"                             .
           display   "id='bnc' name ='bnc' "                          .
           display   "style='text-transform:uppercase;font-weight:bold;'
      -              ""                                               .
      *
           move      spaces               to   w-exe-str-dsp          .
      *
      ...
      *                  *---------------------------------------------*
       ...
       stp-cor-doc-hid-750.
      *              *-------------------------------------------------*
      *              * Status documento 'hidden'                       *
      *              *-------------------------------------------------*
           move      "IH"                 to   h-ope                  .
           move      "sts_bfo"            to   h-nam                  .
           move      w-exe-sts-bfo        to   h-alf                  .
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
       stp-cor-doc-hid-900.
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mhtml0"
                                         using h                      .
      *                  *---------------------------------------------*
      *                  * Literal per Numero bancali                  *
      *                  *---------------------------------------------*
           move      "TD"                 to   h-ope                  .
           move      "th"                 to   h-sub                  .
           move      "Bancali"            to   h-alf                  .
           move      "1"                  to   h-col                  .
           move      "C"                  to   h-all                  .
           move      "B"                  to   h-wdt                  .
           move      "B"                  to   h-stl                  .
      ...
      *                      * Emissione                               *
      *                      *-----------------------------------------*
           display   "<td id='qtl' name='qtl' align='right'>"         .
           display   "<b>"                                            .
           display   p-edt                                            .
           display   "</b>"                                           .
           display   "</td>"                                          .
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<BGD"               to   p-edm                  .
           move      w-det-qta-brc-qta    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Valore                                  *
      ...
      *                      *-----------------------------------------*
           move      w-exe-num-pro        to   w-det-qta-brc-pro      .
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<BGD"               to   p-edm                  .
           move      w-det-qta-brc-qct    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Valore                                  *
      ...
      *                      *-----------------------------------------*
           ...
           move      "<BGD"               to   p-edm                  .
           move      w-det-qta-brc-qta    to   p-num                  .
           subtract  w-det-qta-brc-qct    from p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      spaces               to   p-sgn                  .
           move      "<B"                 to   p-edm                  .
           move      w-det-qta-brc-qbn    to   p-num                  .
           call      "swd/mod/prg/obj/mprint"
                                         using p                      .
      *                      *-----------------------------------------*
      *                      * Valore                                  *
      *                      *-----------------------------------------*
       ...
       stp-cor-doc-pro-800.
      *              *-------------------------------------------------*
      *              * Bottone Trash per tutte le righe                *
      *              *-------------------------------------------------*
           display   "<td id='cel_del' name='cel_del' class='td_nb' rows
      -              "pan=2>"                                         .
           display   "<button type='button' "                         .
           display   "id='del_all' name='del_all' "                   .
      *
           if        w-exe-sts-bfo        =    "A" or
                     w-exe-sts-bfo        =    spaces
                     display   "/>" 
           else      display   " disabled />"                         .
      *
      ...
      *                  *---------------------------------------------*
           display   "<th>"                                           .
           display   "<img src='../../icons/pallet.png' width='40'>"  .
           display   "</th>"                                          .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      zero                 to   w-det-qta-brc-qct      .
           move      zero                 to   w-det-qta-brc-qcu      .
           move      zero                 to   w-det-qta-brc-qbn      .
           move      spaces               to   w-det-qta-brc-qbr      .
       det-qta-brc-100.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
      *                  *---------------------------------------------*
      *                  * Calcolo totale bancali                      *
      *                  *---------------------------------------------*
           if        w-det-qta-brc-qbr    =    spaces
                     go to det-qta-brc-450.
           if        w-det-qta-brc-qbr    =    rf-hbc-sgl-bnc
                     go to det-qta-brc-500.
       det-qta-brc-450.
           move      rf-hbc-sgl-bnc       to   w-det-qta-brc-qbr      .
           add       1                    to   w-det-qta-brc-qbn      .
       det-qta-brc-500.
      *              *-------------------------------------------------*
      *              * Incremento totale                               *
      *              *-------------------------------------------------*
           add       rf-hbc-qta-spl       to   w-det-qta-brc-qct      .
      *              *-------------------------------------------------*
      *              * Ultima riga controllata                         *
      *              *-------------------------------------------------*
           move      rf-hbc-qta-spl       to   w-det-qta-brc-qcu      .
       det-qta-brc-800.
      *              *-------------------------------------------------*
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
