      ...
      *                       Ultima revisione:    NdK del 22/09/17    *
      *                    ------------------------------------------- *
      ...
      *                    (Attualmente in uso)                        *
      *                                                                *
      *                    Solo per emissione file sequenziale         *
      *                    per etichette LabelJoy e per driver         *
      *                    di stampa Datamax                           *
      *                                                                *
      *                    /abd/asc/mag/pdf/out/ods350.txt             *
      *                    (delimitato da TAB)                         *
      *                                                                *
      *                    Eccezione Cliente EVCO (1097)               *
      *                                                                *
      *================================================================*
      ...
      *                      *-----------------------------------------*
           ...
           move      027                  to   w-prm-pst-chm-lfl (6)   .
      *                      *-----------------------------------------*
      *                      * Protocollo o numero documento           *
      *                      *-----------------------------------------*
           move      128                  to   w-prm-pst-chm-pfl (7)   .
      ...
      *                      *-----------------------------------------*
           ...
           move      027                  to   w-prm-pst-chm-lfl (8)   .
      *                      *-----------------------------------------*
      *                      * (libero)                                *
      *                      *-----------------------------------------*
      ...
      *              * SIRI                                            *
      *              *-------------------------------------------------*
           perform   prn-ini-cic-seq-000  thru prn-ini-cic-seq-999    .
       prn-ini-cic-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      "OO"                 to   g-ope                  .
           move      "seq "               to   g-nam                  .
           move      "/abd/asc/mag/pdf/out/ods350.txt"
                                          to   g-pat                  .
      ...
      *              * Labels                                          *
      *              *                                                 *
      *              * ATTUALMENTE NON EMESSE                          *
      *              *-------------------------------------------------*
           go to     prn-ini-cic-seq-900.
       prn-ini-cic-seq-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     prn-ini-cic-seq-999.
       prn-ini-cic-seq-999.
           exit.
      ...
      *              * SIRI                                            *
      *              *-------------------------------------------------*
           perform   prn-fin-cic-seq-000  thru prn-fin-cic-seq-999    .
       prn-fin-cic-999.
           exit.
      ...
      *    * Ciclo Report Program : Esecuzione per fine ciclo          *
      *    *                                                           *
      *    * Emissione sequenziale - chiusura                          *
      *    *                                                           *
      *    * SIRI                                                      *
      *    *-----------------------------------------------------------*
       prn-fin-cic-seq-000.
      ...
      *                  *---------------------------------------------*
       ...
       prn-liv-det-seq-100.
      *              *-------------------------------------------------*
      *              * Ciclo per 'n' etichette                         *
      *              *-------------------------------------------------*
           move      zero                 to   w-det-qta-eti-ctr      .
       prn-liv-det-seq-200.
           add       1                    to   w-det-qta-eti-ctr      .
           if        w-det-qta-eti-ctr    >    w-rig-qta-eti
                     go to prn-liv-det-seq-900.
       prn-liv-det-seq-300.
      *              *-------------------------------------------------*
      *              * Composizione record                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           ...
           move      w-rig-alf-mag        to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      w-rig-cop-scl        to   w-scr-str-ele          .
      *
           if        w-tes-cod-arc (1)    =    0001097
      ...
      *                  *---------------------------------------------*
           move      "A "                 to   w-scr-str-tip          .
           move      w-rig-ocl-num        to   w-scr-str-ele          .
      ...
      *                  *---------------------------------------------*
           ...
           move      "<BD"                to   v-edm                  .
           move      w-rig-qta-ven        to   v-num                  .
           divide    w-rig-qta-eti        into v-num                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *                  *---------------------------------------------*
           ...
           move      w-def-dat-doc        to   w-scr-dat-dat          .
           perform   cmp-sng-fld-000      thru cmp-sng-fld-999        .
      *                  *---------------------------------------------*
      *                  * S-e-p-a-r-a-t-o-r-i                         *
      *                  *---------------------------------------------*
