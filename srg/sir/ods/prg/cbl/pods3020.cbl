      ...
      *                       Ultima revisione:    NdK del 04/02/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Richieste per il programma pods3021:        *
      *                                                                *
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-cod-tos           to   w-cod-des-zsc-cod      .
           move      13                   to   w-cod-des-zsc-lin      .
           move      30                   to   w-cod-des-zsc-pos      .
           move      13                   to   w-cod-des-zsc-dln      .
      ...
      *                  *---------------------------------------------*
           move      rr-cod-tos           to   w-let-arc-zsc-cod      .
           perform   let-arc-zsc-000      thru let-arc-zsc-999        .
           move      w-let-arc-zsc-des    to   rr-cod-tos-des         .
      *                  *---------------------------------------------*
      *                  * Visualizzazione descrizione                 *
      *                  *---------------------------------------------*
           perform   vis-cod-tos-des-000  thru vis-cod-tos-des-999    .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        rr-cod-tos           not  = spaces
                     go to acc-cod-tos-600.
           move      "DS"                 to   v-ope                  .
           move      "A"                  to   v-tip                  .
           move      05                   to   v-car                  .
           move      13                   to   v-lin                  .
      ...
      *    *-----------------------------------------------------------*
       nor-ric-sel-000.
           ...
           move      spaces               to   rr-cod-tos             .
           move      spaces               to   rr-cod-tos-des         .
           move      spaces               to   rr-cod-ute             .
           move      spaces               to   rr-cod-fas             .
       nor-ric-sel-999.
           exit.
