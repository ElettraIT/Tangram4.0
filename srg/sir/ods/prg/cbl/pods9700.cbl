      ...
      *                       Ultima revisione:    NdK del 24/09/24    *
      *                    ------------------------------------------- *
      *                                 Autore:    Nicola de Kunovich  *
      *================================================================*
      *                                                                *
      * Descrizione pgm:   Cancellazione spunte ordini di spedizione   *
      *                                                                *
      *                    SU MISURA PER SIRI                          *
      *                                                                *
      *                    CANCELLAZIONE FILE INIBITA PER PROBLEMI     *
      *                    CON I PRIVILEGI                             *
      *                                                                *
      *================================================================*
      ...
      *        *-------------------------------------------------------*
           05  srt-dat.
      *            *---------------------------------------------------*
      *            * Percorso immagine eventuale                       *
      *            *---------------------------------------------------*
               10  srt-pth-img            pic  x(80)                  .
      ...
      *        *-------------------------------------------------------*
           05  i-ide-des                  pic  x(40) value
                     "   CANCELLAZIONE SPUNTE BARCODE LISTE   "       .
      ...
      *        *-------------------------------------------------------*
      *        * Si/no cancellazione immagini o documenti acquisiti    *
      *        *-------------------------------------------------------*
           05  rr-snx-ida                 pic  9(02)                  .
      ...
      *        *-------------------------------------------------------*
      *        * Work per : Si/no cancellazione immagini o documenti   *
      *        *-------------------------------------------------------*
           05  w-exp-snx-ida.
               10  w-exp-snx-ida-num      pic  9(02)       value 2    .
               10  w-exp-snx-ida-lun      pic  9(02)       value 02   .
               10  w-exp-snx-ida-tbl.
                   15  filler             pic  x(02) value "No"       .
                   15  filler             pic  x(02) value "Si"       .
      ...
      *                  *---------------------------------------------*
       ...
       acc-ric-sel-300.
      *                  *---------------------------------------------*
      *                  * Si/No cancellazione immagini o documenti    *
      *                  *---------------------------------------------*
           perform   acc-snx-ida-000      thru acc-snx-ida-999        .
           if        w-cnt-acc-ric-sel    not  = spaces
                     go to acc-ric-sel-999.
           if        v-key                =    "UP  "
      ...
      *              *-------------------------------------------------*
           ...
           move      11                   to   v-lin                  .
           move      01                   to   v-pos                  .
           move      "Cancellazione immagini e/o :"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *
      ...
      *    *===========================================================*
      *    * Accettazione campo : Si/No cancellazione immagini         *
      *    *-----------------------------------------------------------*
       acc-snx-ida-000.
      *              *-------------------------------------------------*
      *              * Pre-accettazione                                *
      ...
      *              *-------------------------------------------------*
           move      "AC"                 to   v-ope                  .
           move      "E"                  to   v-tip                  .
           move      w-exp-snx-ida-lun    to   v-car                  .
           move      w-exp-snx-ida-num    to   v-ldt                  .
           move      spaces               to   v-edm                  .
           move      "NS#"                to   v-msk                  .
           move      11                   to   v-lin                  .
           move      30                   to   v-pos                  .
           move      w-exp-snx-ida-tbl    to   v-txt                  .
           move      "UP  "               to   v-pfk (01)             .
           move      "DOWN"               to   v-pfk (02)             .
           if        w-cnt-sts-imp-ric    not  = spaces
                     move  "DO  "         to   v-pfk (05)             .
           move      rr-snx-ida           to   v-num                  .
           perform   exe-acc-cmp-000      thru exe-acc-cmp-999        .
      *              *-------------------------------------------------*
      *              * Se Exit                                         *
      *              *-------------------------------------------------*
           if        v-key                =    "EXIT"
                     move  "E"            to   w-cnt-acc-ric-sel
                     go to acc-snx-ida-999.
       acc-snx-ida-200.
      *              *-------------------------------------------------*
      *              * Valore impostato in campo di destinazione       *
      *              *-------------------------------------------------*
           move      v-num                to   rr-snx-ida             .
       acc-snx-ida-400.
      *              *-------------------------------------------------*
      *              * Controllo valore impostato                      *
      *              *-------------------------------------------------*
      ...
      *              * Test su protocollo                              *
      *              *-------------------------------------------------*
           if        rr-prt-ost           not  = zero
                     go to tdo-ric-sel-800.
           move      "Manca il numero ordine !"
      ...
      *              *-------------------------------------------------*
      *              * Si/No cancellazione allegati                    *
      *              *-------------------------------------------------*
           if        rr-snx-ida           =    zero
                     move  01             to   rr-snx-ida             .
       reg-ric-sel-999.
           exit.
      ...
      *              * Scansione [hbc]                                 *
      *              *-------------------------------------------------*
           perform   stp-srt-inp-hbc-000  thru stp-srt-inp-hbc-999    .
       stp-srt-inp-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-prt-ost           to   rf-hbc-num-prt         .
      ...
      *              *-------------------------------------------------*
           ...
           call      "swd/mod/prg/obj/msegrt"
                                         using s                      .
      *              *-------------------------------------------------*
      *              * Lettura sequenziale archivio [hbc]              *
      *              *-------------------------------------------------*
           move      "RN"                 to   f-ope                  .
           move      "sir/agb/fls/ioc/obj/iofhbc"
                                          to   s-pat                  .
      ...
      *                  *---------------------------------------------*
           if        rf-hbc-num-prt       not  = rr-prt-ost
                     go to stp-srt-inp-hbc-900.
       stp-srt-inp-hbc-400.
      *              *-------------------------------------------------*
      ...
      *                  * Chiave di sort                              *
      *                  *---------------------------------------------*
           move      "hbc"                to   srt-tip-rec            .
           move      rf-hbc-num-prt       to   srt-prt-key            .
           move      rf-hbc-num-pro       to   srt-pro-key            .
           move      rf-hbc-num-spl       to   srt-spl-key            .
      *                  *---------------------------------------------*
      *                  * Composizione dati                           *
      *                  *---------------------------------------------*
           move      rf-hbc-pth-img       to   srt-pth-img            .
       stp-srt-inp-hbc-700.
      *              *-------------------------------------------------*
      ...
      *              * Riciclo                                         *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-hbc-200.
       stp-srt-inp-hbc-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
           go to     stp-srt-inp-hbc-999.
       stp-srt-inp-hbc-999.
           exit.
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-int      .
      *              *-------------------------------------------------*
      *              * Cancellazione record [hbc]                      *
      *              *-------------------------------------------------*
           perform   del-rec-hbc-000      thru del-rec-hbc-999        .
      *              *-------------------------------------------------*
      *              * Cancellazione record [hbc] immagini o documenti *
      *              *-------------------------------------------------*
           perform   del-rec-ida-000      thru del-rec-ida-999        .
       prn-liv-det-900.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           if        rr-snx-csp           not  = 02
                     go to del-rec-hbc-999.
      *              *-------------------------------------------------*
      *              * Test su tipo record                             *
      *              *-------------------------------------------------*
           if        srt-tip-rec          not  = "hbc"
                     go to del-rec-hbc-999.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      srt-prt-key          to   rf-hbc-num-prt         .
           move      srt-pro-key          to   rf-hbc-num-pro         .
           move      srt-spl-key          to   rf-hbc-num-spl         .
      *              *-------------------------------------------------*
      *              * Delete record                                   *
      *              *-------------------------------------------------*
           move      "DE"                 to   f-ope                  .
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      "Spunta cancellate con successo !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       del-rec-hbc-999.
      ...
      *    *===========================================================*
      *    * Cancellazione record [hbc] per immagini o documenti       *
      *    *-----------------------------------------------------------*
       del-rec-ida-000.
      *              *-------------------------------------------------*
      *              * Test se da eseguire                             *
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      "Elemento cancellato con successo !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       del-rec-ida-300.
      ...
      *              * Cancellazione file                              *
      *              *                                                 *
      *              * ATTUALMENTE INIBITA PER PROBLEMI DI PRIVILEGI   *
      *              *-------------------------------------------------*
           go to     del-rec-ida-999.
      *                  *---------------------------------------------*
      *                  * Test su filename                            *
      *                  *---------------------------------------------*
           if        srt-pth-img          =    spaces
                     go to del-rec-ida-999.
       del-rec-ida-400.
      *              *-------------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      "WR"                 to   m-ope                  .
           move      "File cancellato con successo !"
                                          to   m-msg                  .
           call      "swd/mod/prg/obj/mmessg"
                                         using m                      .
       del-rec-ida-999.
