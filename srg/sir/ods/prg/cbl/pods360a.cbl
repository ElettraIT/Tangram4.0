      ...
      *                    di spedizione                               *
      *                                                                *
      *                    Sottoprogramma per ordini a clienti         *
      *                                                                *
      *                    SU MISURA PER SIRI                          *
      *                                                                *
      *================================================================*
      ...
      *                  *---------------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
      *                  *---------------------------------------------*
      *                  * Precablaggio iniziale (Nicola 24/01/17)     *
      *                  *                                             *
      *                  * SIRI                                        *
      *                  *---------------------------------------------*
           move      "OS   "              to   rr-tip-mov             .
      ...
      *              *-------------------------------------------------*
           ...
           move      rr-tip-mov           to   w-cod-des-zsc-cod      .
           move      05                   to   w-cod-des-zsc-lin      .
           move      30                   to   w-cod-des-zsc-pos      .
           move      05                   to   w-cod-des-zsc-dln      .
           move      37                   to   w-cod-des-zsc-dps      .
      ...
      *                  * Lettura tabella [zsc]                       *
      *                  *---------------------------------------------*
           move      rr-tip-mov           to   w-let-arc-zsc-cod      .
           move      zero                 to   w-let-arc-zsc-dpz      .
           perform   let-arc-zsc-000      thru let-arc-zsc-999        .
           move      w-let-arc-zsc-des    to   rr-tip-mov-des         .
      *                  *---------------------------------------------*
      ...
      *              *-------------------------------------------------*
           move      spaces               to   w-cnt-prn-flg-sub      .
      *              *-------------------------------------------------*
      *              * Start su archivio [ost] per data registrazione  *
      *              *-------------------------------------------------*
           move      "SK"                 to   f-ope                  .
           move      "NL"                 to   f-cfr                  .
           move      "DATDOC    "         to   f-key                  .
           move      rr-dpz-inu           to   rf-ost-cod-dpz         .
           move      rr-dat-min           to   rf-ost-dat-doc         .
      ...
      *              *-------------------------------------------------*
           if        rf-ost-num-prt       <    rr-noc-min or
      ...
      *              *-------------------------------------------------*
           if        rf-ost-cod-arc       <    rr-cli-min or
                     rf-ost-cod-arc       >    rr-cli-max
                     go to prn-sel-rec-900.
       prn-sel-rec-300.
      *              *-------------------------------------------------*
      *              * Uscita                                          *
      ...
      *                  *---------------------------------------------*
           move      rf-ost-num-col       to   w-cix-num-col          .
