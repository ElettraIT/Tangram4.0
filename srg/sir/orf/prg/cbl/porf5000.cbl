      ...
      *                       Ultima revisione:    NdK del 11/09/17    *
      *                    ------------------------------------------- *
      ...
      *                                                                *
      *                    N.B.: ... attualmente non vengono aggiorna- *
      *                              ti i totali ordine !!!            *
      *                                                                *
      *                    SU MISURA PER SIRI                          *
      *                                                                *
      ...
      *    *-----------------------------------------------------------*
       01  w-rig.
           ...
           05  w-rig-edi-prg              pic  9(05)                  .
           05  w-rig-flg-rch              pic  x(01)                  .
      ...
      *                *-----------------------------------------------*
                   ...
                   15  w-lin-imm-qta-ord  pic  x(11)                  .
                   15  w-lin-imm-brv-003  pic  x(01)                  .
                   15  w-lin-imm-prz-acq  pic  x(12)                  .
      ...
      *                *-----------------------------------------------*
                   ...
                   15  w-lin-imm-qta-ric  pic  x(11)                  .
                   15  w-lin-imm-br2-003  pic  x(01)                  .
                   15  w-lin-imm-sgl-vpl  pic  x(03)                  .
                   15  w-lin-imm-ccr-vpl  pic  x(09)                  .
      ...
      *        * Flag di riga chiusa                                   *
      *        *-------------------------------------------------------*
           05  w-sav-flg-rch              pic  x(01)                  .
           05  w-sav-flg-rch-pf2          pic  x(01)                  .
      *        *-------------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-det-qta-sec-qim      pic s9(08)v9(03)            .
      *            *---------------------------------------------------*
      ...
      *            *---------------------------------------------------*
               10  w-det-qta-sec-qts      pic s9(08)v9(03)            .
      *            *---------------------------------------------------*
      *            * Work-area di lavoro                               *
      *            *---------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           move      w-tes-tmo-orf        to   w-bla-emb-str          .
      ...
      *    *===========================================================*
      *    * Accettazione campo testata : Riferimenti conferma da for- *
      *    * nitore                                                    *
      *    *-----------------------------------------------------------*
       acc-cof-rif-000.
      *              *-------------------------------------------------*
      ...
      *
           if        w-rig-snx-tum        =    "P"
                     ...
                     move  w-rig-qta-ord  to   w-edt-qta-inc-qta
           else      move  w-rig-qta-fda  to   w-edt-qta-inc-qta      .
      *
           if        w-rig-snx-tum        =    "P"
      ...
      *                      * Flag                                    *
      *                      *-----------------------------------------*
           move      w-rig-flg-cnf        to   w-lin-imm-flg-cnf      .
       vis-lin-cor-600.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
      *                      * Eventuale segnale di riga chiusa        *
      *                      *-----------------------------------------*
      *                          *-------------------------------------*
      *                          * Test                                *
      *                          *-------------------------------------*
           if        w-rig-flg-rch        =    spaces
                     go to vis-lin-cor-620.
      *                          *-------------------------------------*
      *                          * Indicazione riga chiusa             *
      *                          *-------------------------------------*
           move      "*** CHIUSA ***"     to   w-lin-imm-d15-p03      .
      *                          *-------------------------------------*
      *                          * Allineamento a destra               *
      *                          *-------------------------------------*
      ...
      *                          *-------------------------------------*
       ...
       vis-lin-cor-620.
      *                      *-----------------------------------------*
      *                      * PN casa produttrice, seconda tranche    *
      *                      *                                         *
      *                      * SONIA - 11/09/2017                      *
      *                      *-----------------------------------------*
           move      w-rig-cdp-pdt
                    (15:16)               to   w-lin-imm-d15-p03      .
      *
           go to     vis-lin-cor-700.
      *                      *-----------------------------------------*
      *                      * Descrizione - ultimi 15 caratteri       *
      *                      *-----------------------------------------*
           move      w-rig-der-rig (1)    to   w-bla-emb-str          .
           move      w-bla-emb-str
      ...
      *                      *-----------------------------------------*
           move      "ED"                 to   w-edt-qta-inc-ope      .
           move      w-rig-qta-ric        to   w-edt-qta-inc-qta      .
      *
           if        w-rig-snx-tum        =    "P"
                     move  w-rig-dec-qta  to   w-edt-qta-inc-dec
           else if   w-rig-snx-tum        =    "S"
      ...
      *                      *-----------------------------------------*
           move      w-rig-sgl-vpl        to   w-lin-imm-sgl-vpl      .
      *                      *-----------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           call      "swd/mod/prg/obj/mvideo"
                                         using v                      .
           move      v-edt                to   w-lin-imm-ccr-vpl      .
      *                      *-----------------------------------------*
      *                      * Editing data consegna richiesta         *
      *                      *-----------------------------------------*
           move      "ED"                 to   v-ope                  .
           move      "D"                  to   v-tip                  .
      ...
      *              *-------------------------------------------------*
           ...
           move      06                   to   v-lin                  .
           move      45                   to   v-pos                  .
           move      "|Q.ord/Q.arr|   Prezzo   |Prev/Ric|C"
                                          to   v-alf                  .
           call      "swd/mod/prg/obj/mvideo"
                                        using  v                      .
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-snx-tum        =    "P"
                     move  w-rig-qta-ord  to   w-sav-qta-ord
           else if   w-rig-snx-tum        =    "S"
                     move  w-rig-qta-fda  to   w-sav-qta-ord
           else      move  w-rig-qta-fda  to   w-sav-qta-ord          .
      *                  *---------------------------------------------*
      *                  * Salvataggio flag di riga chiusa             *
      *                  *---------------------------------------------*
           move      w-rig-flg-rch        to   w-sav-flg-rch          .
           move      spaces               to   w-sav-flg-rch-pf2      .
       acc-qta-ord-100.
      *              *-------------------------------------------------*
      *              * Accettazione valore                             *
      *              *-------------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-snx-tum        =    "P"
                     move  w-sav-qta-ord  to   w-rig-qta-ord
           else if   w-rig-snx-tum        =    "S"
                     move  w-sav-qta-ord  to   w-rig-qta-fda
           else      move  w-sav-qta-ord  to   w-rig-qta-fda          .
      *                  *---------------------------------------------*
      *                  * Parametri generici                          *
      *                  *---------------------------------------------*
           move      "AC"                 to   v-ope                  .
      ...
      *                      *-----------------------------------------*
           if        w-rig-snx-tum        =    "P"
                     move  w-rig-qta-ord  to   v-num
           else if   w-rig-snx-tum        =    "S"
                     move  w-rig-qta-fda  to   v-num
           else      move  w-rig-qta-fda  to   v-num                  .
       acc-qta-ord-200.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-flg-rch        =    spaces
                     move  "#"            to   w-rig-flg-rch
           else      move  spaces         to   w-rig-flg-rch          .
      *                  *---------------------------------------------*
      *                  * Flag di attivazione tasto funzione          *
      *                  *---------------------------------------------*
           move      "#"                  to   w-sav-flg-rch-pf2      .
      *                  *---------------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-rig-snx-tum        =    "P"
                     move  v-num          to   w-rig-qta-ord
           else if   w-rig-snx-tum        =    "S"
                     move  v-num          to   w-rig-qta-fda
           else      move  v-num          to   w-rig-qta-fda          .
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           if        w-sav-qta-cfr        =    w-sav-qta-ord
                     go to acc-qta-ord-800.
      *                      *-----------------------------------------*
      ...
      *                  *---------------------------------------------*
           if        w-sav-flg-rch-pf2    not  = spaces
      ...
      *                      * Determinazione                          *
      *                      *-----------------------------------------*
           move      w-rig-prz-acq        to   w-det-prz-net-prz      .
      ...
      *                  *---------------------------------------------*
           if        w-rig-flg-cnf        =    spaces or
                     w-rig-flg-cnf        =    "?"
                     go to acc-flg-cnf-600.
           if        w-rig-flg-cnf        not  <  "0" and
                     w-rig-flg-cnf        not  >  "9"
                     go to acc-flg-cnf-600.
           if        w-rig-flg-cnf        not  <  "A" and
                     w-rig-flg-cnf        not  >  "Z"
                     go to acc-flg-cnf-600
      ...
      *                      *-----------------------------------------*
           if        rf-oft-cof-dat       =    zero   and
                     rf-oft-cof-num       =    spaces and
                     rf-oft-cof-rif       =    spaces
      ...
      *                          *-------------------------------------*
           ...
           move      rf-oft-cof-dat       to   w-tes-cof-dat (1)      .
           move      rf-oft-cof-num       to   w-tes-cof-num (1)      .
           move      rf-oft-cof-rif       to   w-tes-cof-rif (1)      .
      ...
      *                  *---------------------------------------------*
           ...
           move      rf-ofr-flg-rch       to   w-rig-flg-rch          .
       rou-let-reg-605.
      *                          *-------------------------------------*
      *                          * Valori contenuti indirettamente in  *
      *                          * record [ofr]                        *
      ...
      *                  *---------------------------------------------*
           if        w-tes-val-aep (1)    =    w-tes-val-aep (2)
                     go to sca-fil-rap-050.
      *                  *---------------------------------------------*
      ...
      *                      *-----------------------------------------*
           ...
           move      w-rig-qta-ord        to   rf-ofr-qta-ord         .
           move      w-rig-qta-fda        to   rf-ofr-qta-fda         .
           move      w-rig-prz-acq        to   rf-ofr-prz-acq         .
           move      w-rig-prz-net        to   rf-ofr-prz-net         .
           move      w-rig-imp-rig        to   rf-ofr-imp-rig         .
      *                      *-----------------------------------------*
      *                      * Data accettata in consegna prevista     *
      *                      *-----------------------------------------*
           move      w-rig-dcn-prv        to   rf-ofr-dcn-prv         .
      *                      *-----------------------------------------*
      *                      * Data accettata in consegna confermata   *
      *                      *-----------------------------------------*
           move      w-rig-dcn-prv        to   rf-ofr-dcn-cnf         .
      *                      *-----------------------------------------*
      *                      * Trattamento flag conferma               *
      *                      *-----------------------------------------*
           move      w-rig-flg-cnf        to   rf-ofr-flg-cnf         .
      *                      *-----------------------------------------*
      *                      * Trattamento flag riga chiusa            *
      *                      *-----------------------------------------*
           move      w-rig-flg-rch        to   rf-ofr-flg-rch         .
      *                  *---------------------------------------------*
      *                  * Update record [ofr]                         *
      *                  *---------------------------------------------*
           move      "UP"                 to   f-ope                  .
      ...
      *                  *---------------------------------------------*
           ...
           call      s-pat               using f
                                               rf-ofr                 .
      *                  *---------------------------------------------*
      *                  * Riciclo su incremento contatore records     *
      *                  * scaricati                                   *
      *                  *---------------------------------------------*
           go to     sca-fil-rap-100.
       sca-fil-rap-900.
      ...
      *              *-------------------------------------------------*
           ...
           move      w-rig-prz-acq        to   d-imp-acq-prz-uni      .
